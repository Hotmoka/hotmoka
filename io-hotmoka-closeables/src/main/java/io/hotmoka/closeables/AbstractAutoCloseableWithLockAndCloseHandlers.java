...
import io.hotmoka.closeables.internal.AutoCloseableWithLockAndHandlersImpl;
 ...
 */
@ThreadSafe
public abstract class AbstractAutoCloseableWithLockAndCloseHandlers<E extends Exception> extends AutoCloseableWithLockAndHandlersImpl<E> {
	 ...
	 */
	protected AbstractAutoCloseableWithLockAndCloseHandlers(Supplier<E> exceptionSupplier) {
