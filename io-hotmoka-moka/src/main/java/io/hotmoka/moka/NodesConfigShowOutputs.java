...
public abstract class NodesConfigShowOutputs {
	...
	/**
	 * Yields the output of the command.
	 * 
	 * @param config the configuration in the output of the command
	 * @return the output of the command
	 */
	public static NodesConfigShowOutput of(ConsensusConfig<?,?> config) {
		return new Show.Output(config);
	}
