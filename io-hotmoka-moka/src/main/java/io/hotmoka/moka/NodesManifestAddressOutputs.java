...
/**
 * Providers of outputs for the {@code moka nodes manifest address} command.
 */
public abstract class NodesManifestAddressOutputs {

	private NodesManifestAddressOutputs() {}
	 ...
	 * JSON representation.
	 */
	public static class Json extends NodesManifestAddressOutputJson {
		 ...
		 */
		public Json(NodesManifestAddressOutput output) {
			super(output);
		}
	}
	 ...
	 * JSON encoder.
	 */
	public static class Encoder extends MappedEncoder<NodesManifestAddressOutput, Json> {
	 ...
	 * JSON decoder.
	 */
	public static class Decoder extends MappedDecoder<NodesManifestAddressOutput, Json> {
