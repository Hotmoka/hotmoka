...
/**
 * Providers of outputs for the {@code moka objects show} command.
 */
public abstract class ObjectsShowOutputs {

	private ObjectsShowOutputs() {}
	 ...
	 */
	public static ObjectsShowOutput from(String json) throws DecodeException {
	 ...
	 * JSON representation.
	 */
	public static class Json extends ObjectsShowOutputJson {
	 ...
	 * JSON encoder.
	 */
	public static class Encoder extends MappedEncoder<ObjectsShowOutput, Json> {
	 ...
	 * JSON decoder.
	 */
	public static class Decoder extends MappedDecoder<ObjectsShowOutput, Json> {
