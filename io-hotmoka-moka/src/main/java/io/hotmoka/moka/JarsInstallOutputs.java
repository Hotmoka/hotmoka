...
/**
 * Providers of outputs for the {@code moka jars install} command.
 */
public abstract class JarsInstallOutputs {

	private JarsInstallOutputs() {}
	 ...
	 */
	public static JarsInstallOutput from(String json) throws DecodeException {
	 ...
	 * JSON representation.
	 */
	public static class Json extends JarsInstallOutputJson {
	 ...
	 * JSON encoder.
	 */
	public static class Encoder extends MappedEncoder<JarsInstallOutput, Json> {
	 ...
	 * JSON decoder.
	 */
	public static class Decoder extends MappedDecoder<JarsInstallOutput, Json> {
