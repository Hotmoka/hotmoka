...
public class NodesTendermintValidatorsTests extends AbstractMokaTestWithNode {
	...
	public void validatorAccountCreationFromFaucetWorks() throws Exception {
		...
		var accountsCreateOutput = NodesTendermintValidatorsCreateOutputs.from(MokaNew.nodesTendermintValidatorsCreate("12345 --keys=" + keyCreateOutputs.getFile() + " --password=" + passwordOfNewAccount + " --json --output-dir=" + dir));
	...
	public void validatorAccountCreationFromOtherAccountWorks() throws Exception {
		...
		var accountsCreateOutput = NodesTendermintValidatorsCreateOutputs.from(MokaNew.nodesTendermintValidatorsCreate("12345 --payer=" + gamete + " --password-of-payer=" + passwordOfGamete + " --dir=" + dir + " --keys=" + keyCreateOutputs.getFile() + " --password=" + passwordOfNewAccount + " --json --output-dir=" + dir));
		TransactionResponse response = node.getResponse(accountsCreateOutput.getTransaction());
