 ...
 */
public class CallerOutsideFromContractError extends AbstractVerificationError {
	 ...
	 */
	public CallerOutsideFromContractError(String where, MethodGen method, int line) {
		super(where, method, line, "caller() can only be used inside a @FromContract method or constructor");
	}
	 ...
	 */
	public CallerOutsideFromContractError(String where, String message) {
		super(where, message);
	}
}