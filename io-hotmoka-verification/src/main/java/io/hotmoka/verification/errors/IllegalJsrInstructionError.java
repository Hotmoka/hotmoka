...
public class IllegalJsrInstructionError extends AbstractVerificationError {
	 ...
	 */
	public IllegalJsrInstructionError(String where, MethodGen method, int line) {
		super(where, method, line, "bytecode JSR is not allowed");
	}
	 ...
	 */
	public IllegalJsrInstructionError(String where, String message) {
		super(where, message);
	}
}