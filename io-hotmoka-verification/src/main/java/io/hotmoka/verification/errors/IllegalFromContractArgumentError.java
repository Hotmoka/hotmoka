...
public class IllegalFromContractArgumentError extends AbstractVerificationError {
	 ...
	 */
	public IllegalFromContractArgumentError(String where, MethodGen method) {
		super(where, method, -1, "the argument of @FromContract must be a contract");
	}
	 ...
	 */
	public IllegalFromContractArgumentError(String where, String message) {
		super(where, message);
	}
}