...
/**
 * An error issued when a redefining method uses {@code @@RedPayable}}
...
public class InconsistentRedPayableError extends AbstractErrorImpl {
	 ...
	 */
	public InconsistentRedPayableError(String where, String methodName, String classWhereItWasDefined) {
		super(where, methodName, -1, "@RedPayable is inconsistent with definition of the same method in class " + classWhereItWasDefined);
	}
}