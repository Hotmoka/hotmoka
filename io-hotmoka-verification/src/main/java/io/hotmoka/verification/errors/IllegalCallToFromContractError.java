 ...
 */
public class IllegalCallToFromContractError extends AbstractVerificationError {
	 ...
	 */
	public IllegalCallToFromContractError(String where, MethodGen method, String fromContractMethodName, int line) {
		super(where, method, line, "\"" + fromContractMethodName + "\" is @FromContract, hence it can only be called from an instance method or constructor of a contract");
	}
	 ...
	 */
	public IllegalCallToFromContractError(String where, String message) {
		super(where, message);
	}
}