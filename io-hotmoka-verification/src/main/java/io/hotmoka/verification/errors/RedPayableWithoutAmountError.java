...
/**
 * An error issued when a {@code @@RedPayable} method has not a first argument for the paid amount.
 */
public class RedPayableWithoutAmountError extends AbstractErrorImpl {
