...
public class IllegalRetInstructionError extends AbstractVerificationError {
	 ...
	 */
	public IllegalRetInstructionError(String where, MethodGen method, int line) {
		super(where, method, line, "bytecode RET is not allowed");
	}
	 ...
	 */
	public IllegalRetInstructionError(String where, String message) {
		super(where, message);
	}
}