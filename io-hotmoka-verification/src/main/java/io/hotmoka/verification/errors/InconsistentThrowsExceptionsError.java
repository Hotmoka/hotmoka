...
public class InconsistentThrowsExceptionsError extends AbstractVerificationError {
	 ...
	 */
	public InconsistentThrowsExceptionsError(String where, String methodName, String classWhereItWasDefined) {
		super(where, methodName, -1, "@ThrowsExceptions is inconsistent with definition of the same method in class " + classWhereItWasDefined);
	}
}