 ...
 */
public class InconsistentThrowsExceptionsError extends AbstractVerificationError {
	 ...
	 */
	public InconsistentThrowsExceptionsError(String where, MethodGen method, String classWhereItWasDefined) {
		super(where, method, -1, "@ThrowsExceptions is inconsistent with definition of the same method in class " + classWhereItWasDefined);
	}
	 ...
	 */
	public InconsistentThrowsExceptionsError(String where, String message) {
		super(where, message);
	}
}