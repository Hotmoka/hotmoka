...
public class IllegalFinalizerError extends AbstractVerificationError {
	 ...
	 */
	public IllegalFinalizerError(String where, MethodGen method, int line) {
		super(where, method, line, "finalizers are not allowed");
	}
	 ...
	 */
	public IllegalFinalizerError(String where, String message) {
		super(where, message);
	}
}