...
public class InconsistentFromContractError extends AbstractVerificationError {
	 ...
	 */
	public InconsistentFromContractError(String where, MethodGen method, String classWhereItWasDefined) {
		super(where, method, -1, "@FromContract is inconsistent with the definition of the same method in class " + classWhereItWasDefined);
	}
	 ...
	 */
	public InconsistentFromContractError(String where, String message) {
		super(where, message);
	}
}