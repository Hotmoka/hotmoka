...
public class IllegalCallToPayableConstructorOnThis extends AbstractVerificationError {
	 ...
	 */
	public IllegalCallToPayableConstructorOnThis(String where, MethodGen method, int line) {
		super(where, method, line, "only a @Payable constructor can call another @Payable constructor by chaining");
	}
	 ...
	 */
	public IllegalCallToPayableConstructorOnThis(String where, String message) {
		super(where, message);
	}
}