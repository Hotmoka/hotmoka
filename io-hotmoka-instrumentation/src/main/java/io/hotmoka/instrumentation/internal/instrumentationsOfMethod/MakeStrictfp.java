...
/**
 * Makes a method or constructor {@code strictfp}, so that its floating point behavior is deterministic.
 */
public class MakeStrictfp extends MethodLevelInstrumentation {
	 ...
	 */
	public MakeStrictfp(InstrumentedClassImpl.Builder builder, MethodGen method) {
		builder.super(method);

		if (!method.isAbstract())
			method.setAccessFlags(method.getAccessFlags() | Const.ACC_STRICT);
	}
}