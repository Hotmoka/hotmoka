...
public class ConstructorCallTransactionExceptionResponseImpl extends CodeExecutionTransactionResponseImpl implements ConstructorCallTransactionExceptionResponse {
	 ...
	 */
	public ConstructorCallTransactionExceptionResponseImpl(String classNameOfCause, String messageOfCause, String where, Stream<Update> updates, Stream<StorageReference> events, BigInteger gasConsumedForCPU, BigInteger gasConsumedForRAM, BigInteger gasConsumedForStorage) {
	 ...
	 */
	public static ConstructorCallTransactionExceptionResponseImpl from(UnmarshallingContext context) throws IOException {
