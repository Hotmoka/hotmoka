...
public final class UpdateOfFloatImpl extends UpdateOfFieldImpl implements UpdateOfFloat {
	 ...
	 */
	private <E extends Exception> UpdateOfFloatImpl(StorageReference object, FieldSignature field, float value, ExceptionSupplierFromMessage<? extends E> onIllegalArgs) throws E {
