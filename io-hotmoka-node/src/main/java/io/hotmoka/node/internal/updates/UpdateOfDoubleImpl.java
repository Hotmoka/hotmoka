...
public final class UpdateOfDoubleImpl extends UpdateOfFieldImpl implements UpdateOfDouble {
	 ...
	 */
	private <E extends Exception> UpdateOfDoubleImpl(StorageReference object, FieldSignature field, double value, ExceptionSupplierFromMessage<? extends E> onIllegalArgs) throws E {
