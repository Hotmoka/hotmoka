...
public final class UpdateOfByteImpl extends UpdateOfFieldImpl implements UpdateOfByte {
	 ...
	 * @throws E if some argument is illegal
	 */
	private <E extends Exception> UpdateOfByteImpl(StorageReference object, FieldSignature field, byte value, ExceptionSupplierFromMessage<? extends E> onIllegalArgs) throws E {
