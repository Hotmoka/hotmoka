...
public class DiskStoreTransaction extends AbstractStoreTransaction<DiskStore> {
	...
	public DiskStore commit() throws StoreException {
		return new DiskStore(getStore(), Optional.of(getConfigUncommitted()), getGasPriceUncommitted(), getInflationUncommitted(), requests, responses, histories, errors, Optional.ofNullable(manifest.get()));
	}
