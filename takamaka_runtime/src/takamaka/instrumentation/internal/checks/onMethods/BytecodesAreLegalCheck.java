...
import takamaka.instrumentation.issues.IllegalJsrInstructionError;
import takamaka.instrumentation.issues.IllegalPutstaticInstructionError;
import takamaka.instrumentation.issues.IllegalRetInstructionError;
import takamaka.instrumentation.issues.IllegalSynchronizationError;
import takamaka.instrumentation.issues.IllegalUpdateOfLocal0Error;
 ...
 */
public class BytecodesAreLegalCheck extends VerifiedClassGen.ClassVerification.MethodVerification.Check {

	public BytecodesAreLegalCheck(VerifiedClassGen.ClassVerification.MethodVerification verification) {
		verification.super();
