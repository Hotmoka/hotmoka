 ...
 */
public class StorageClassesHaveFieldsOfStorageTypeCheck extends VerifiedClassGenImpl.Verification.Check {

	public StorageClassesHaveFieldsOfStorageTypeCheck(VerifiedClassGenImpl.Verification verification) {
		verification.super();
