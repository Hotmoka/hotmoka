 ...
 */
public class IsNotStaticInitializerCheck extends VerifiedClassGen.Verifier.MethodVerifier.Check {

	public IsNotStaticInitializerCheck(VerifiedClassGen.Verifier.MethodVerifier verifier) {
		verifier.super();
