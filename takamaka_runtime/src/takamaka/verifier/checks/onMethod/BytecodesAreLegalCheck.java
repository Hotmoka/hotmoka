 ...
 */
public class BytecodesAreLegalCheck extends VerifiedClassGen.Verifier.MethodVerifier.Check {

	public BytecodesAreLegalCheck(VerifiedClassGen.Verifier.MethodVerifier verifier) {
		verifier.super();
