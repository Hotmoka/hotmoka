...
import io.takamaka.instrumentation.internal.checksOnClass.BootstrapsAreLegalCheck;
import io.takamaka.instrumentation.internal.checksOnClass.EntriesAreOnlyCalledFromContractsCheck;
import io.takamaka.instrumentation.internal.checksOnClass.PackagesAreLegalCheck;
import io.takamaka.instrumentation.internal.checksOnClass.StorageClassesHaveFieldsOfStorageTypeCheck;
import io.takamaka.instrumentation.internal.checksOnMethods.BytecodesAreLegalCheck;
import io.takamaka.instrumentation.internal.checksOnMethods.CallerIsUsedOnThisAndInEntryCheck;
import io.takamaka.instrumentation.internal.checksOnMethods.EntryCodeIsConsistentWithClassHierarchyCheck;
import io.takamaka.instrumentation.internal.checksOnMethods.EntryCodeIsInstanceAndInContractsCheck;
import io.takamaka.instrumentation.internal.checksOnMethods.ExceptionHandlersAreForCheckedExceptionsCheck;
import io.takamaka.instrumentation.internal.checksOnMethods.IsNotNativeCheck;
import io.takamaka.instrumentation.internal.checksOnMethods.IsNotStaticInitializerCheck;
import io.takamaka.instrumentation.internal.checksOnMethods.IsNotSynchronizedCheck;
import io.takamaka.instrumentation.internal.checksOnMethods.PayableCodeIsConsistentWithClassHierarchyCheck;
import io.takamaka.instrumentation.internal.checksOnMethods.PayableCodeIsEntryCheck;
import io.takamaka.instrumentation.internal.checksOnMethods.PayableCodeReceivesAmountCheck;
import io.takamaka.instrumentation.internal.checksOnMethods.ThrowsExceptionsCodeIsPublicCheck;
import io.takamaka.instrumentation.internal.checksOnMethods.ThrowsExceptionsIsConsistentWithClassHierarchyCheck;
import io.takamaka.instrumentation.internal.checksOnMethods.UsedCodeIsWhiteListedCheck;
	...
	public class ClassVerification {
		...
		public abstract class Check {
			...
			protected final void issue(Issue issue) {
				...
				hasErrors |= issue instanceof io.takamaka.instrumentation.issues.Error;
			}
