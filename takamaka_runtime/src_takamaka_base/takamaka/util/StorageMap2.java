 ...
 *  map for comparable keys. The map can be kept in storage. Both keys
 *  and values must have type allowed in storage.
 *  
...
public class StorageMap2<K extends Comparable<K>, E> extends Storage {
