...
public class StaticViewMethodCallResponseBuilder extends StaticMethodCallResponseBuilder {
	 ...
	 */
	public StaticViewMethodCallResponseBuilder(TransactionReference reference, StaticMethodCallTransactionRequest request, StoreTransaction<?> transaction, NodeInternal node) throws TransactionRejectedException {
