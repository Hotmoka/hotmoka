 ...
 * 
 * java --module-path modules/explicit:modules/automatic --class-path "modules/unnamed/*" --module io.hotmoka.runs/io.hotmoka.runs.InitTendermintV1N1Node0
 */
public class InitTendermintV1N1Node0 extends Run {
	...
	private static void runSillyTransactions(Node node, PrivateKey privateKeyOfGamete) throws Exception {
		...
		Signer signer = Signer.with(SignatureAlgorithmForTransactionRequests.mk(node.getNameOfSignatureAlgorithmForRequests()), privateKeyOfGamete);
