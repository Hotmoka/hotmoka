...
public class InstallC1 {
	...
	public static void main(String[] args) throws Exception {
		...
		try (Node node = RemoteNode.of(config)) {
			...
			Path c1Path = Paths.get("io-takamaka-examples/target/io-takamaka-examples-1.0.0-wtsc2021_c1.jar");
			...
			TransactionReference ref = node.addJarStoreTransaction(new JarStoreTransactionRequest
				...
				BigInteger.ONE, // nonce (the gamete has already been used to install the Takamaka runtime)
				"test", // chain id
