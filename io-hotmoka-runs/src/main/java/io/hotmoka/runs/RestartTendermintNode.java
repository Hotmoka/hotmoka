 ...
 * 
 * java --module-path modules/explicit:modules/automatic --class-path "modules/unnamed/*" --module io.hotmoka.runs/io.hotmoka.runs.RestartTendermintNode
 */
public class RestartTendermintNode extends Run {
