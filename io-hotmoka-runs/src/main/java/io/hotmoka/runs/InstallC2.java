...
public class InstallC2 {
	...
	public static void main(String[] args) throws Exception {
		...
		try (Node node = RemoteNode.of(config)) {
			...
			Path c1Path = Paths.get("io-hotmoka-examples/target/io-hotmoka-examples-1.0.0-wtsc2021_c2.jar");
			...
			System.out.print("Installing C2 in the node... ");
