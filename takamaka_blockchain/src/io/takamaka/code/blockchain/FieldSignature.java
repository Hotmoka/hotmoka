...
public final class FieldSignature implements Serializable, Comparable<FieldSignature> {
	...
	/**
	 * A cache for {@link io.takamaka.code.blockchain.FieldSignature#mk(String, String, StorageType)}.
	 */
	...
	/**
	 * Clears the cache used for {@link io.takamaka.code.blockchain.FieldSignature#mk(String, String, StorageType)}.
	 */
