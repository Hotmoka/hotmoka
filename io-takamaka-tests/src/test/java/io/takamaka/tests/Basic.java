...
class Basic extends TakamakaTest {
	...
	void testToStringInternationTime() throws TransactionException, CodeExecutionException {
		StorageReference internationalTime = blockchain.addConstructorCallTransaction
			(new ConstructorCallTransactionRequest(master, _200_000, BigInteger.ONE, classpath, CONSTRUCTOR_INTERNATIONAL_TIME,
			new IntValue(13), new IntValue(25), new IntValue(40)));
		assertEquals(new StringValue("13:25:40"),
			blockchain.addInstanceMethodCallTransaction(new InstanceMethodCallTransactionRequest(master, _200_000, BigInteger.ONE, classpath, TO_STRING, internationalTime)));
	}
	...
	void testToStringWrapperInternationTime1() throws TransactionException, CodeExecutionException {
		...
		StorageReference wrapper = blockchain.addConstructorCallTransaction
			(new ConstructorCallTransactionRequest(master, _200_000, BigInteger.ONE, classpath, CONSTRUCTOR_WRAPPER_1,
			internationalTime));
		assertEquals(new StringValue("wrapper(13:25:40,null,null,0)"),
			blockchain.addInstanceMethodCallTransaction(new InstanceMethodCallTransactionRequest(master, _200_000, BigInteger.ONE, classpath, TO_STRING, wrapper)));
	}
	...
	void testToStringWrapperInternationTime2() throws TransactionException, CodeExecutionException {
		StorageReference internationalTime = blockchain.addConstructorCallTransaction
			...
			new IntValue(13), new IntValue(25), new IntValue(40)));
		StorageReference wrapper = blockchain.addConstructorCallTransaction
			(new ConstructorCallTransactionRequest(master, _200_000, BigInteger.ONE, classpath, CONSTRUCTOR_WRAPPER_2,
	...
	void callPayableConstructor() throws TransactionException, CodeExecutionException {
		blockchain.addConstructorCallTransaction(new ConstructorCallTransactionRequest
			(master, _200_000, BigInteger.ONE, classpath, new ConstructorSignature("io.takamaka.tests.basic.Sub", INT), new IntValue(1973)));
	}
	...
	void callStaticAsInstance() throws CodeExecutionException, TransactionException {
		...
		throwsTransactionExceptionWithCause(NoSuchMethodException.class, () ->
			blockchain.addInstanceMethodCallTransaction(new InstanceMethodCallTransactionRequest(master, _200_000, BigInteger.ONE, classpath, SUB_MS, sub))
		);
	}

	@Test @DisplayName("Sub.ms()")
	void callStaticAsStatic() throws CodeExecutionException, TransactionException {
		blockchain.addStaticMethodCallTransaction(new StaticMethodCallTransactionRequest(master, _200_000, BigInteger.ONE, classpath, SUB_MS));
	}
	...
	void callInstanceAsStatic() throws CodeExecutionException, TransactionException {
		throwsTransactionExceptionWithCause(NoSuchMethodException.class, () ->
			blockchain.addStaticMethodCallTransaction(new StaticMethodCallTransactionRequest(master, _200_000, BigInteger.ONE, classpath, SUB_M5))
		);
	}
	...
	void callerHasNotEnoughFundsForGas() throws CodeExecutionException, TransactionException {
		StorageReference eoa = blockchain.addConstructorCallTransaction(new ConstructorCallTransactionRequest
			(master, _200_000, BigInteger.ONE, classpath, new ConstructorSignature(ClassType.EOA)));

		throwsTransactionException(() ->
			blockchain.addConstructorCallTransaction
				(new ConstructorCallTransactionRequest(eoa, _200_000, BigInteger.ONE, classpath, new ConstructorSignature("io.takamaka.tests.basic.Sub", INT), new IntValue(1973)))
		);
	}
	...
	void callerHasNotEnoughFundsForPayableEntry() throws CodeExecutionException, TransactionException {
		StorageReference eoa = blockchain.addConstructorCallTransaction(new ConstructorCallTransactionRequest
			(master, _200_000, BigInteger.ONE, classpath, new ConstructorSignature(ClassType.EOA)));
		blockchain.addInstanceMethodCallTransaction
			(new InstanceMethodCallTransactionRequest(master, _200_000, BigInteger.ONE, classpath, PAYABLE_CONTRACT_RECEIVE, eoa, new IntValue(200000)));
	...
	void callerHasEnoughFundsForPayableEntry() throws CodeExecutionException, TransactionException {
		StorageReference eoa = blockchain.addConstructorCallTransaction(new ConstructorCallTransactionRequest
			(master, _200_000, BigInteger.ONE, classpath, new ConstructorSignature(ClassType.EOA)));
		blockchain.addInstanceMethodCallTransaction
			(new InstanceMethodCallTransactionRequest(master, _200_000, BigInteger.ONE, classpath, PAYABLE_CONTRACT_RECEIVE, eoa, new IntValue(20000)));
		blockchain.addConstructorCallTransaction
			(new ConstructorCallTransactionRequest(eoa, _5_000, BigInteger.ONE, classpath, new ConstructorSignature("io.takamaka.tests.basic.Sub", INT), new IntValue(1973)));
	}
	...
	void callInstanceMethod() throws CodeExecutionException, TransactionException {
		...
		StorageReference sub = blockchain.addConstructorCallTransaction
			(new ConstructorCallTransactionRequest(eoa, _5_000, BigInteger.ONE, classpath, new ConstructorSignature("io.takamaka.tests.basic.Sub", INT), new IntValue(1973)));
		blockchain.addInstanceMethodCallTransaction
			(new InstanceMethodCallTransactionRequest(master, _200_000, BigInteger.ONE, classpath, new VoidMethodSignature("io.takamaka.tests.basic.Sub", "print", new ClassType("io.takamaka.tests.basicdependency.Time")), sub, internationalTime));
	}
	...
	void callPayableEntryWithInt() throws CodeExecutionException, TransactionException {
		...
		assertEquals(new StringValue("Sub.m4 receives 13 coins from an externally owned account with public balance"), blockchain.addInstanceMethodCallTransaction
			(new InstanceMethodCallTransactionRequest(master, _200_000, BigInteger.ONE, classpath, new NonVoidMethodSignature("io.takamaka.tests.basic.Sub", "m4", ClassType.STRING, INT), sub, new IntValue(13))));
	}
	...
	void callPayableEntryWithLong() throws CodeExecutionException, TransactionException {
		StorageReference eoa = blockchain.addConstructorCallTransaction(new ConstructorCallTransactionRequest
			(master, _200_000, BigInteger.ONE, classpath, new ConstructorSignature(ClassType.EOA)));
		blockchain.addInstanceMethodCallTransaction
			(new InstanceMethodCallTransactionRequest(master, _200_000, BigInteger.ONE, classpath, PAYABLE_CONTRACT_RECEIVE, eoa, new IntValue(2000000)));
		StorageReference sub = blockchain.addConstructorCallTransaction
			(new ConstructorCallTransactionRequest(eoa, _200_000, BigInteger.ONE, classpath, new ConstructorSignature("io.takamaka.tests.basic.Sub", INT), new IntValue(1973)));
		assertEquals(new StringValue("Sub.m4_1 receives 13 coins from an externally owned account with public balance"), blockchain.addInstanceMethodCallTransaction
			(new InstanceMethodCallTransactionRequest(master, _200_000, BigInteger.ONE, classpath, new NonVoidMethodSignature("io.takamaka.tests.basic.Sub", "m4_1", ClassType.STRING, LONG), sub, new LongValue(13L))));
	}
	...
	void callPayableEntryWithBigInteger() throws CodeExecutionException, TransactionException {
		...
		assertEquals(new StringValue("Sub.m4_2 receives 13 coins from an externally owned account with public balance"), blockchain.addInstanceMethodCallTransaction
			(new InstanceMethodCallTransactionRequest(master, _200_000, BigInteger.ONE, classpath, new NonVoidMethodSignature("io.takamaka.tests.basic.Sub", "m4_2", ClassType.STRING, ClassType.BIG_INTEGER),
	...
	void aliasBetweenStorage1() throws CodeExecutionException, TransactionException {
		...
		StorageReference a1 = blockchain.addConstructorCallTransaction(new ConstructorCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, CONSTRUCTOR_ALIAS));
		StorageReference a2 = blockchain.addConstructorCallTransaction(new ConstructorCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, CONSTRUCTOR_ALIAS));
		assertEquals(new BooleanValue(false), blockchain.addInstanceMethodCallTransaction
			(new InstanceMethodCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, new NonVoidMethodSignature(alias, "test", BasicTypes.BOOLEAN, alias, alias), a1, a1, a2)));
	}
	...
	void aliasBetweenStorage2() throws CodeExecutionException, TransactionException {
		...
		assertEquals(new BooleanValue(true), blockchain.addInstanceMethodCallTransaction
			(new InstanceMethodCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, new NonVoidMethodSignature(alias, "test", BasicTypes.BOOLEAN, alias, alias), a1, a1, a1)));
	}
	...
	void aliasBetweenString() throws CodeExecutionException, TransactionException {
		...
		assertEquals(new BooleanValue(false), blockchain.addInstanceMethodCallTransaction
			(new InstanceMethodCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, new NonVoidMethodSignature(alias, "test", BasicTypes.BOOLEAN, ClassType.STRING, ClassType.STRING), a1, s1, s2)));
	}
	...
	void aliasBetweenString2() throws CodeExecutionException, TransactionException {
		...
		StringValue s1 = new StringValue("hello");
		assertEquals(new BooleanValue(false), blockchain.addInstanceMethodCallTransaction
			(new InstanceMethodCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, new NonVoidMethodSignature(alias, "test", BasicTypes.BOOLEAN, ClassType.STRING, ClassType.STRING), a1, s1, s1)));
	}
	...
	void aliasBetweenBigInteger1() throws CodeExecutionException, TransactionException {
		...
		assertEquals(new BooleanValue(false), blockchain.addInstanceMethodCallTransaction
			(new InstanceMethodCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, new NonVoidMethodSignature(alias, "test", BasicTypes.BOOLEAN, ClassType.BIG_INTEGER, ClassType.BIG_INTEGER),
			a1, bi1, bi2)));
	}
	...
	void viewMethodViolation1() throws CodeExecutionException, TransactionException {
		...
		StorageReference s = blockchain.addConstructorCallTransaction
			(new ConstructorCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, new ConstructorSignature(simple, INT), new IntValue(13)));

		throwsTransactionExceptionWithCause(SideEffectsInViewMethodException.class, () ->
			blockchain.addInstanceMethodCallTransaction
				(new InstanceMethodCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, new VoidMethodSignature(simple, "foo1"), s))
		);
	}
	...
	void viewMethodViolation2() throws CodeExecutionException, TransactionException {
		...
		throwsTransactionExceptionWithCause(SideEffectsInViewMethodException.class, () ->
			blockchain.addInstanceMethodCallTransaction
				(new InstanceMethodCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, new NonVoidMethodSignature(simple, "foo2", simple), s))
		);
	}
	...
	void viewMethodOk1() throws CodeExecutionException, TransactionException {
		...
		assertEquals(new IntValue(13),
			blockchain.addInstanceMethodCallTransaction
			(new InstanceMethodCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, new NonVoidMethodSignature(simple, "foo3", INT), s)));
	}
	...
	void viewMethodOk2() throws CodeExecutionException, TransactionException {
		ClassType simple = new ClassType("io.takamaka.tests.basic.Simple");
		StorageReference s = blockchain.addConstructorCallTransaction
			(new ConstructorCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, new ConstructorSignature(simple, BasicTypes.INT), new IntValue(13)));

		assertEquals(new IntValue(13),
			blockchain.addInstanceMethodCallTransaction
			(new InstanceMethodCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, new NonVoidMethodSignature(simple, "foo4", INT), s)));
	}
	...
	void viewMethodOk3() throws CodeExecutionException, TransactionException {
		...
		assertEquals(new IntValue(14),
			...
			(new StaticMethodCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, new NonVoidMethodSignature(simple, "foo5", INT))));
	}
	...
	void listCreation() throws CodeExecutionException, TransactionException {
		...
		StorageReference wl = blockchain.addConstructorCallTransaction
			(new ConstructorCallTransactionRequest(master, _200_000, BigInteger.ONE, classpath, new ConstructorSignature(withList)));
		assertEquals(new StringValue("[hello,how,are,you]"),
			blockchain.addInstanceMethodCallTransaction
			(new InstanceMethodCallTransactionRequest(master, _200_000, BigInteger.ONE, classpath, new NonVoidMethodSignature(withList, "toString", ClassType.STRING),
			wl)));
	}
	...
	void deserializationError() throws CodeExecutionException, TransactionException {
		...
		throwsTransactionExceptionWithCause(DeserializationError.class, () ->
			blockchain.addInstanceMethodCallTransaction
				(new InstanceMethodCallTransactionRequest(master, _200_000, BigInteger.ONE, classpath, new VoidMethodSignature(withList, "illegal"),
				wl))
		);
	}
	...
	void entryFilterOk1() throws CodeExecutionException, TransactionException {
		...
		StorageReference ef = blockchain.addConstructorCallTransaction
			(new ConstructorCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, new ConstructorSignature(entryFilter)));
		blockchain.addInstanceMethodCallTransaction
			(new InstanceMethodCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, new VoidMethodSignature(entryFilter, "foo1"), ef));
	}
	...
	void entryFilterOk2() throws CodeExecutionException, TransactionException {
		...
		StorageReference ef = blockchain.addConstructorCallTransaction
			(new ConstructorCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, new ConstructorSignature(entryFilter)));
		blockchain.addInstanceMethodCallTransaction
			(new InstanceMethodCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, new VoidMethodSignature(entryFilter, "foo2"), ef));
	}
	...
	void entryFilterOk3() throws CodeExecutionException, TransactionException {
		...
		StorageReference ef = blockchain.addConstructorCallTransaction
			(new ConstructorCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, new ConstructorSignature(entryFilter)));
		blockchain.addInstanceMethodCallTransaction
			(new InstanceMethodCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, new VoidMethodSignature(entryFilter, "foo3"), ef));
	}
	...
	void entryFilterFails() throws CodeExecutionException, TransactionException {
		...
		throwsTransactionExceptionWithCause(ClassCastException.class, () ->
			blockchain.addInstanceMethodCallTransaction
				(new InstanceMethodCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, new VoidMethodSignature(entryFilter, "foo4"), ef))
		);
	}
	...
	void entryFilterFailsWithThrowsExceptions() throws CodeExecutionException, TransactionException {
		...
		try {
			blockchain.addInstanceMethodCallTransaction
				(new InstanceMethodCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, new VoidMethodSignature(entryFilter, "foo5"), ef));
		}
	...
	void entryFilterFailsWithoutThrowsExceptions() throws CodeExecutionException, TransactionException {
		...
		Assertions.assertThrows(TransactionException.class, () ->
			blockchain.addInstanceMethodCallTransaction
				(new InstanceMethodCallTransactionRequest(master, _5_000, BigInteger.ONE, classpath, new VoidMethodSignature(entryFilter, "foo6"), ef)));
	}
}