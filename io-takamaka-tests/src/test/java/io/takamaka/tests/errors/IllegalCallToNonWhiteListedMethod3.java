...
class IllegalCallToNonWhiteListedMethod3 extends TakamakaTest {
	...
	void installJar() throws TransactionException, CodeExecutionException, IOException {
		TransactionReference jar = addJarStoreTransaction(account(0), _20_000, BigInteger.ONE, takamakaCode(),
			bytesOf("illegalcalltononwhitelistedmethod3.jar"), takamakaCode());
