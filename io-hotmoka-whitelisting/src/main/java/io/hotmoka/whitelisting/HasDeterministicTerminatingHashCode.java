...
import io.hotmoka.whitelisting.internal.checks.HasDeterministicTerminatingHashCodeCheck;
...
@Inherited
@Documented
@WhiteListingProofObligation(check = HasDeterministicTerminatingHashCodeCheck.class)
