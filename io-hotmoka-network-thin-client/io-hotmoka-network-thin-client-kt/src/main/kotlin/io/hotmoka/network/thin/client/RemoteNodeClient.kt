...
class RemoteNodeClient(url: String): RemoteNode {
    ...
    /**
     * Invokes a GET request to an endpoint.
    ...
    private fun <T> get(url: String, resultType: Class<T>): T {
        ...
        return httpCall(request, resultType)
    }
    ...
    /**
     * It performs an http call GET or POST.
     * @param request the request
     * @param resultType the result type class
     */
    private fun <T> httpCall(request: Request, resultType: Class<T>): T {
