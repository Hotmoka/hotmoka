 ...
 */
public class SimpleSharedEntity<O extends SharedEntity.Offer> extends PayableContract implements SharedEntity<O> {
	 ...
	 */
	public SimpleSharedEntity(PayableContract[] shareholders, BigInteger[] shares) {
	 ...
	 */
	public SimpleSharedEntity(PayableContract shareholder, BigInteger share) {
     ...
     */
    public SimpleSharedEntity(PayableContract shareholder1, PayableContract shareholder2, BigInteger share1, BigInteger share2) {
