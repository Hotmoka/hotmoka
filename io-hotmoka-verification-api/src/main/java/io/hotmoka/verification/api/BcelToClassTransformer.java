...
public interface BcelToClassTransformer {
	 ...
	 * @throws UnknownTypeException if {@code type} is a class that cannot be found in the Takamaka program 
	 */
	Class<?> of(Type type) throws UnknownTypeException;
	 ...
	 * @throws UnknownTypeException if some of the {@code types} is a class that cannot be found in the Takamaka program 
	 */
	Class<?>[] of(Type[] types) throws UnknownTypeException;
}