...
class IllegalExceptionHandler3 extends TakamakaTest {
	...
	void installJar() {
		throwsVerificationExceptionWithCause(UncheckedExceptionHandlerError.class, () ->
			blockchain.addJarStoreTransaction
				...
				Files.readAllBytes(Paths.get("../takamaka_examples/dist/illegalexceptionhandler3.jar")), blockchain.takamakaBase))
		);
	}
}