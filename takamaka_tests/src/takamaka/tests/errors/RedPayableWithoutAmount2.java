...
class RedPayableWithoutAmount2 extends TakamakaTest {
	...
	void installJar() {
		throwsVerificationExceptionWithCause(RedPayableWithoutAmountError.class, () ->
			blockchain.addJarStoreTransaction
				...
				Files.readAllBytes(Paths.get("../takamaka_examples/dist/redpayablewithoutamount2.jar")), blockchain.takamakaCode()))
		);
	}
}