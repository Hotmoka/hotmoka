...
import io.takamaka.instrumentation.issues.UncheckedExceptionHandlerError;
import takamaka.blockchain.request.JarStoreTransactionRequest;
import takamaka.memory.InitializedMemoryBlockchain;
import takamaka.tests.TakamakaTest;

class IllegalExceptionHandler1 extends TakamakaTest {
	...
	void installJar() {
		throwsVerificationExceptionWithCause(UncheckedExceptionHandlerError.class, () ->
			blockchain.addJarStoreTransaction
				...
				Files.readAllBytes(Paths.get("../takamaka_examples/dist/illegalexceptionhandler1.jar")), blockchain.takamakaBase))
		);
	}
}