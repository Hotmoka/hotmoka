...
class IllegalCallToNonWhiteListedMethod3 {
	...
	void installJar() throws TransactionException, CodeExecutionException, IOException {
		...
		try {
			blockchain.addStaticMethodCallTransaction(new StaticMethodCallTransactionRequest
				...
				new NonVoidMethodSignature(new ClassType("takamaka.tests.errors.illegalcalltononwhitelistedmethod3.C"), "foo", ClassType.STRING)));
		}
