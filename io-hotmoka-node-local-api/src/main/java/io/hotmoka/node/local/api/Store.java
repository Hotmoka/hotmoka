...
public interface Store<S extends Store<S, T>, T extends StoreTransaction<S, T>> extends AutoCloseable {
	 ...
	 */
	Optional<TransactionRequest<?>> getRequest(TransactionReference reference) throws StoreException;
	 ...
	 */
	Optional<TransactionResponse> getResponse(TransactionReference reference) throws StoreException;
