...
import io.takamaka.code.util.SnapshottableStorageIntMap;
import io.takamaka.code.util.SnapshottableStorageTreeIntMap;

/**
 * This class defines methods that test the snapshottable storage map with integer keys implementation.
 */
public class SnapshottableIntMapTests {

	public static @View int testIteration1() {
		var map = new SnapshottableStorageTreeIntMap<BigInteger>();
	...
	private static int sum(SnapshottableStorageIntMap<BigInteger> map) {
		class WrappedInt {
			int i;
		}
