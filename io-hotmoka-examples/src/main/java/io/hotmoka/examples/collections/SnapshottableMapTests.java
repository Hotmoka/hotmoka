...
/**
 * This class defines methods that test the snapshottable storage map implementation.
 */
public class SnapshottableMapTests {

	public static @View int testIteration1() {
		var map = new SnapshottableStorageTreeMap<BigInteger, BigInteger>();
	...
	private static int sum(SnapshottableStorageMap<BigInteger, BigInteger> map) {
		class WrappedInt {
			int i;
		}
