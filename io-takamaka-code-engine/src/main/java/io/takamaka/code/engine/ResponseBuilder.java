...
public interface ResponseBuilder<Request extends TransactionRequest<Response>, Response extends TransactionResponse> {
	 ...
	 */
	static ResponseBuilder<JarStoreInitialTransactionRequest, JarStoreInitialTransactionResponse> of(TransactionReference reference, JarStoreInitialTransactionRequest request, AbstractNodeWithHistory<?> node) throws TransactionRejectedException {
	 ...
	 * @throws TransactionRejectedException if the builder cannot be created
	 */
	static ResponseBuilder<GameteCreationTransactionRequest, GameteCreationTransactionResponse> of(TransactionReference reference, GameteCreationTransactionRequest request, AbstractNodeWithHistory<?> node) throws TransactionRejectedException {
	 ...
	 * @throws TransactionRejectedException if the builder cannot be created
	 */
	static ResponseBuilder<RedGreenGameteCreationTransactionRequest, GameteCreationTransactionResponse> of(TransactionReference reference, RedGreenGameteCreationTransactionRequest request, AbstractNodeWithHistory<?> node) throws TransactionRejectedException {
	 ...
	 * @throws TransactionRejectedException if the builder cannot be created
	 */
	static ResponseBuilder<InitializationTransactionRequest, InitializationTransactionResponse> of(TransactionReference reference, InitializationTransactionRequest request, AbstractNodeWithHistory<?> node) throws TransactionRejectedException {
	 ...
	 * @throws TransactionRejectedException if the builder cannot be created
	 */
	static ResponseBuilder<JarStoreTransactionRequest, JarStoreTransactionResponse> of(TransactionReference reference, JarStoreTransactionRequest request, AbstractNodeWithHistory<?> node) throws TransactionRejectedException {
	 ...
	 * @throws TransactionRejectedException if the builder cannot be created
	 */
	static ResponseBuilder<ConstructorCallTransactionRequest, ConstructorCallTransactionResponse> of(TransactionReference reference, ConstructorCallTransactionRequest request, AbstractNodeWithHistory<?> node) throws TransactionRejectedException {
	 ...
	 * @throws TransactionRejectedException if the builder cannot be created
	 */
	static ResponseBuilder<InstanceMethodCallTransactionRequest, MethodCallTransactionResponse> of(TransactionReference reference, InstanceMethodCallTransactionRequest request, AbstractNodeWithHistory<?> node) throws TransactionRejectedException {
	 ...
	 * @throws TransactionRejectedException if the builder cannot be created
	 */
	static ResponseBuilder<StaticMethodCallTransactionRequest, MethodCallTransactionResponse> of(TransactionReference reference, StaticMethodCallTransactionRequest request, AbstractNodeWithHistory<?> node) throws TransactionRejectedException {
	 ...
	 * @throws TransactionRejectedException if the builder cannot be created
	 */
	static ResponseBuilder<InstanceMethodCallTransactionRequest, MethodCallTransactionResponse> ofView(TransactionReference reference, InstanceMethodCallTransactionRequest request, AbstractNodeWithHistory<?> node) throws TransactionRejectedException {
	 ...
	 * @throws TransactionRejectedException if the builder cannot be created
	 */
	static ResponseBuilder<StaticMethodCallTransactionRequest, MethodCallTransactionResponse> ofView(TransactionReference reference, StaticMethodCallTransactionRequest request, AbstractNodeWithHistory<?> node) throws TransactionRejectedException {
	 ...
	 * @throws TransactionRejectedException if the builder cannot be created
	 */
	static ResponseBuilder<?,?> of(TransactionReference reference, TransactionRequest<?> request, AbstractNodeWithHistory<?> node) throws TransactionRejectedException {
