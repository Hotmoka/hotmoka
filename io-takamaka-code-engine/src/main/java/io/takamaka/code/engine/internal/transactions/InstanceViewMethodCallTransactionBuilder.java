...
public class InstanceViewMethodCallTransactionBuilder extends InstanceMethodCallTransactionBuilder {
	 ...
	 */
	public InstanceViewMethodCallTransactionBuilder(InstanceMethodCallTransactionRequest request, TransactionReference current, Node node) throws TransactionRejectedException {
