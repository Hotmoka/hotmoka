...
public class Marshallable  {
    ...
    protected static boolean verify(byte[] what, byte[] signatureBytes, PublicKey publicKey) throws Exception {
        Signature signature = Signature.getInstance("Ed25519");
