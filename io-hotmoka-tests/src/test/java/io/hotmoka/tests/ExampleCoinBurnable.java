...
class ExampleCoinBurnable extends HotmokaTest {
    ...
    void createExampleCoinBurnable() throws Exception {
    ...
    void burn() throws Exception {
        ...
        StorageReference creator_balance = (StorageReference) runInstanceNonVoidMethodCallTransaction(creator, _500_000, jar(), MethodSignatures.ofNonVoid(EXCB, "balanceOf", UBI, StorageTypes.CONTRACT), example_token, creator);
    ...
    void burnFrom() throws Exception {
        StorageReference example_token = addConstructorCallTransaction(creator_prv_key, creator, _500_000, panarea(1), jar(), CONSTRUCTOR_EXCB);
        ...
        StorageReference investor1_balance = (StorageReference) runInstanceNonVoidMethodCallTransaction(creator, _500_000, jar(), MethodSignatures.ofNonVoid(EXCB, "balanceOf", UBI, StorageTypes.CONTRACT), example_token, investor1);
        ...
        StorageReference ubi_remaining_allowance = (StorageReference) runInstanceNonVoidMethodCallTransaction(creator, _500_000, jar(), MethodSignatures.ofNonVoid(EXCB, "allowance", UBI, StorageTypes.CONTRACT, StorageTypes.CONTRACT), example_token, creator, investor1);
        // ubi_remaining_allowance = allowances[creator[investor1]] = 7000 - 4000 (just burned) = 3000
        BooleanValue equals_result3 = (BooleanValue) runInstanceNonVoidMethodCallTransaction(creator, _500_000, classpath_takamaka_code, MethodSignatures.ofNonVoid(UBI, "equals", BOOLEAN, StorageTypes.OBJECT), ubi_remaining_allowance, ubi_3000);
        // equals_result3 = ubi_remaining_allowance.equals(3000) = true

        StorageReference supply = (StorageReference) runInstanceNonVoidMethodCallTransaction(creator, _500_000, jar(), MethodSignatures.ofNonVoid(EXCB, "totalSupply", UBI), example_token);
        // supply = example_token.totalSupply() == 200'000*10^18 - 4000 = 199999999999999999996000
        BooleanValue equals_result4 = (BooleanValue) runInstanceNonVoidMethodCallTransaction(creator, _500_000, classpath_takamaka_code, MethodSignatures.ofNonVoid(UBI, "equals", BOOLEAN, StorageTypes.OBJECT), supply, ubi_check);
    ...
    void burnFromException() throws Exception {
        StorageReference example_token = addConstructorCallTransaction(creator_prv_key, creator, _500_000, panarea(1), jar(), CONSTRUCTOR_EXCB);
        ...
        StorageReference investor2_balance = (StorageReference) runInstanceNonVoidMethodCallTransaction(creator, _500_000, jar(), MethodSignatures.ofNonVoid(EXCB, "balanceOf", UBI, StorageTypes.CONTRACT), example_token, investor2);
