...
class SharedEntity2AllowsArbitraryShareholdersTypes extends HotmokaTest {
    ...
    private static final ClassType SHARED_ENTITY_2 = StorageTypes.of("io.hotmoka.examples.sharedentities.SharedEntity2");
    private static final ClassType SIMPLE_SHARED_ENTITY_2 = StorageTypes.of("io.hotmoka.examples.sharedentities.SimpleSharedEntity2");
    private static final ClassType OFFER_2 = StorageTypes.of(SHARED_ENTITY_2 + "$Offer");
