...
class Collections extends HotmokaTest {
	...
	void randomArray() throws Exception {
		...
		assertEquals(1225, runStaticNonVoidMethodCallTransaction(eoa, _10_000_000, jar(), testRandomInitialization).asReturnedInt(testRandomInitialization, UnexpectedValueException::new));
	}
	...
	void randomArrayCountNulls() throws Exception {
		...
		assertEquals(50L, runStaticNonVoidMethodCallTransaction(eoa, _10_000_000, jar(), countNullsAfterRandomInitialization).asReturnedLong(countNullsAfterRandomInitialization, UnexpectedValueException::new));
	}
	...
	void randomArrayThenUpdate1() throws Exception {
		...
		assertEquals(1325, runStaticNonVoidMethodCallTransaction(eoa, _10_000_000, jar(), testUpdateWithDefault1).asReturnedInt(testUpdateWithDefault1, UnexpectedValueException::new));
	}
	...
	void randomArrayThenUpdate2() throws Exception {
		...
		assertEquals(1225, runStaticNonVoidMethodCallTransaction(eoa, _10_000_000, jar(), testUpdateWithDefault2).asReturnedInt(testUpdateWithDefault2, UnexpectedValueException::new));
	}
	...
	void randomArrayTheGetOrDefault() throws Exception {
		...
		assertEquals(1225, runStaticNonVoidMethodCallTransaction(eoa, _10_000_000, jar(), testGetOrDefault).asReturnedInt(testGetOrDefault, UnexpectedValueException::new));
	}
	...
	void mapHolderGet0() throws Exception {
		...
		assertTrue(runInstanceNonVoidMethodCallTransaction(eoa, _10_000_000, jar(), isRunning, mapHolder, state).asReturnedBoolean(isRunning, UnexpectedValueException::new));
	}
	...
	void mapHolderGet1() throws Exception {
		...
		assertTrue(runInstanceNonVoidMethodCallTransaction(eoa, _10_000_000, jar(), isSleeping, mapHolder, state).asReturnedBoolean(isSleeping, UnexpectedValueException::new));
	}
	...
	void mapHolderGet10() throws Exception {
		...
		assertTrue(runInstanceNonVoidMethodCallTransaction(eoa, _10_000_000, jar(), isWaiting, mapHolder, state).asReturnedBoolean(isWaiting, UnexpectedValueException::new));
	}
	...
	void mapHolderGet0State() throws Exception {
		...
		assertTrue(runInstanceNonVoidMethodCallTransaction(eoa, _10_000_000, jar(), isRunning2, mapHolder, state).asReturnedBoolean(isRunning2, UnexpectedValueException::new));
	}
	...
	void mapHolderGet1State() throws Exception {
		...
		assertTrue(runInstanceNonVoidMethodCallTransaction(eoa, _10_000_000, jar(), isSleeping2, mapHolder, state).asReturnedBoolean(isSleeping2, UnexpectedValueException::new));
	}
	...
	void mapHolderGet10State() throws Exception {
		...
		assertTrue(runInstanceNonVoidMethodCallTransaction(eoa, _10_000_000, jar(), isWaiting2, mapHolder, state).asReturnedBoolean(isWaiting2, UnexpectedValueException::new));
	}
	...
	void mapHolderGet0Comparable() throws Exception {
		...
		assertTrue(runInstanceNonVoidMethodCallTransaction(eoa, _10_000_000, jar(), isRunning3, mapHolder, state).asReturnedBoolean(isRunning3, UnexpectedValueException::new));
	}
	...
	void mapHolderGet1Comparable() throws Exception {
		...
		assertTrue(runInstanceNonVoidMethodCallTransaction(eoa, _10_000_000, jar(), isSleeping3, mapHolder, state).asReturnedBoolean(isSleeping3, UnexpectedValueException::new));
	}
	...
	void mapHolderGet10Comparable() throws Exception {
		...
		assertTrue(runInstanceNonVoidMethodCallTransaction(eoa, _10_000_000, jar(), isWaiting3, mapHolder, state).asReturnedBoolean(isWaiting3, UnexpectedValueException::new));
	}
}