...
class Collections extends TakamakaTest {
	...
	void geometricSum() throws TransactionException, CodeExecutionException, TransactionRejectedException {
		IntValue sum = (IntValue) runStaticMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_TESTS, "testIteration1", INT));
	...
	void geometricSumAfterUpdate() throws TransactionException, CodeExecutionException, TransactionRejectedException {
		IntValue sum = (IntValue) runStaticMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_TESTS, "testUpdate1", INT));
	...
	void geometricSumAfterUpdateWithStream() throws TransactionException, CodeExecutionException, TransactionRejectedException {
		IntValue sum = (IntValue) runStaticMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_TESTS, "testUpdate2", INT));
		assertEquals(5050, sum.value);
	}
	...
	void nullValuesInMap() throws TransactionException, CodeExecutionException, TransactionRejectedException {
		LongValue count = (LongValue) runStaticMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_TESTS, "testNullValues", LONG));
	...
	void geometricSumIntKeys() throws TransactionException, CodeExecutionException, TransactionRejectedException {
		IntValue sum = (IntValue) runStaticMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(INT_MAP_TESTS, "testIteration1", INT));
		assertEquals(4950, sum.value);
	}
	...
	void geometricSumAfterUpdateIntKeys() throws TransactionException, CodeExecutionException, TransactionRejectedException {
		IntValue sum = (IntValue) runStaticMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(INT_MAP_TESTS, "testUpdate1", INT));
		assertEquals(5050, sum.value);
	}
	...
	void geometricSumAfterUpdateIntKeysWithStream() throws TransactionException, CodeExecutionException, TransactionRejectedException {
		IntValue sum = (IntValue) runStaticMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(INT_MAP_TESTS, "testUpdate2", INT));
		assertEquals(5050, sum.value);
	}
	...
	void nullValuesInMapIntKeys() throws TransactionException, CodeExecutionException, TransactionRejectedException {
		LongValue count = (LongValue) runStaticMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(INT_MAP_TESTS, "testNullValues", LONG));
		assertEquals(100L, count.value);
	}
	...
	void randomArray() throws TransactionException, CodeExecutionException, TransactionRejectedException {
		IntValue sum = (IntValue) runStaticMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(ARRAY_TESTS, "testRandomInitialization", INT));
	...
	void randomArrayCountNulls() throws TransactionException, CodeExecutionException, TransactionRejectedException {
		LongValue count = (LongValue) runStaticMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(ARRAY_TESTS, "countNullsAfterRandomInitialization", LONG));
	...
	void randomArrayThenUpdate1() throws TransactionException, CodeExecutionException, TransactionRejectedException {
		IntValue sum = (IntValue) runStaticMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(ARRAY_TESTS, "testUpdateWithDefault1", INT));
	...
	void randomArrayThenUpdate2() throws TransactionException, CodeExecutionException, TransactionRejectedException {
		IntValue sum = (IntValue) runStaticMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(ARRAY_TESTS, "testUpdateWithDefault2", INT));
		assertEquals(1225, sum.value);
	}
	...
	void randomArrayTheGetOrDefault() throws TransactionException, CodeExecutionException, TransactionRejectedException {
		IntValue sum = (IntValue) runStaticMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(ARRAY_TESTS, "testGetOrDefault", INT));
		assertEquals(1225, sum.value);
	}
	...
	void mapHolderGet0() throws TransactionException, CodeExecutionException, TransactionRejectedException, InvalidKeyException, SignatureException {
		...
		StorageValue state = runInstanceMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_HOLDER, "get0", STATE), mapHolder);
		BooleanValue result = (BooleanValue) runInstanceMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_HOLDER, "isRunning", BOOLEAN, ClassType.OBJECT), mapHolder, state);
	...
	void mapHolderGet1() throws TransactionException, CodeExecutionException, TransactionRejectedException, InvalidKeyException, SignatureException {
		StorageReference mapHolder = addConstructorCallTransaction(key, eoa, _5_000_000, BigInteger.ONE, jar(), new ConstructorSignature(MAP_HOLDER));
		StorageValue state = runInstanceMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_HOLDER, "get1", STATE), mapHolder);
		BooleanValue result = (BooleanValue) runInstanceMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_HOLDER, "isSleeping", BOOLEAN, ClassType.OBJECT), mapHolder, state);
		assertTrue(result.value);
	}
	...
	void mapHolderGet10() throws TransactionException, CodeExecutionException, TransactionRejectedException, InvalidKeyException, SignatureException {
		StorageReference mapHolder = addConstructorCallTransaction(key, eoa, _5_000_000, BigInteger.ONE, jar(), new ConstructorSignature(MAP_HOLDER));
		StorageValue state = runInstanceMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_HOLDER, "get10", STATE), mapHolder);
		BooleanValue result = (BooleanValue) runInstanceMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_HOLDER, "isWaiting", BOOLEAN, ClassType.OBJECT), mapHolder, state);
		assertTrue(result.value);
	}
	...
	void mapHolderGet0State() throws TransactionException, CodeExecutionException, TransactionRejectedException, InvalidKeyException, SignatureException {
		StorageReference mapHolder = addConstructorCallTransaction(key, eoa, _5_000_000, BigInteger.ONE, jar(), new ConstructorSignature(MAP_HOLDER));
		StorageValue state = runInstanceMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_HOLDER, "get0", STATE), mapHolder);
		BooleanValue result = (BooleanValue) runInstanceMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_HOLDER, "isRunning2", BOOLEAN, STATE), mapHolder, state);
		assertTrue(result.value);
	}
	...
	void mapHolderGet1State() throws TransactionException, CodeExecutionException, TransactionRejectedException, InvalidKeyException, SignatureException {
		StorageReference mapHolder = addConstructorCallTransaction(key, eoa, _5_000_000, BigInteger.ONE, jar(), new ConstructorSignature(MAP_HOLDER));
		StorageValue state = runInstanceMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_HOLDER, "get1", STATE), mapHolder);
		BooleanValue result = (BooleanValue) runInstanceMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_HOLDER, "isSleeping2", BOOLEAN, STATE), mapHolder, state);
		assertTrue(result.value);
	}
	...
	void mapHolderGet10State() throws TransactionException, CodeExecutionException, TransactionRejectedException, InvalidKeyException, SignatureException {
		StorageReference mapHolder = addConstructorCallTransaction(key, eoa, _5_000_000, BigInteger.ONE, jar(), new ConstructorSignature(MAP_HOLDER));
		StorageValue state = runInstanceMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_HOLDER, "get10", STATE), mapHolder);
		BooleanValue result = (BooleanValue) runInstanceMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_HOLDER, "isWaiting2", BOOLEAN, STATE), mapHolder, state);
		assertTrue(result.value);
	}
	...
	void mapHolderGet0Comparable() throws TransactionException, CodeExecutionException, TransactionRejectedException, InvalidKeyException, SignatureException {
		StorageReference mapHolder = addConstructorCallTransaction(key, eoa, _5_000_000, BigInteger.ONE, jar(), new ConstructorSignature(MAP_HOLDER));
		StorageValue state = runInstanceMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_HOLDER, "get0", STATE), mapHolder);
		BooleanValue result = (BooleanValue) runInstanceMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_HOLDER, "isRunning3", BOOLEAN, COMPARABLE), mapHolder, state);
		assertTrue(result.value);
	}
	...
	void mapHolderGet1Comparable() throws TransactionException, CodeExecutionException, TransactionRejectedException, InvalidKeyException, SignatureException {
		StorageReference mapHolder = addConstructorCallTransaction(key, eoa, _5_000_000, BigInteger.ONE, jar(), new ConstructorSignature(MAP_HOLDER));
		StorageValue state = runInstanceMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_HOLDER, "get1", STATE), mapHolder);
		BooleanValue result = (BooleanValue) runInstanceMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_HOLDER, "isSleeping3", BOOLEAN, COMPARABLE), mapHolder, state);
		assertTrue(result.value);
	}
	...
	void mapHolderGet10Comparable() throws TransactionException, CodeExecutionException, TransactionRejectedException, InvalidKeyException, SignatureException {
		StorageReference mapHolder = addConstructorCallTransaction(key, eoa, _5_000_000, BigInteger.ONE, jar(), new ConstructorSignature(MAP_HOLDER));
		StorageValue state = runInstanceMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_HOLDER, "get10", STATE), mapHolder);
		BooleanValue result = (BooleanValue) runInstanceMethodCallTransaction(eoa, _5_000_000, jar(), new NonVoidMethodSignature(MAP_HOLDER, "isWaiting3", BOOLEAN, COMPARABLE), mapHolder, state);
		assertTrue(result.value);
	}
}