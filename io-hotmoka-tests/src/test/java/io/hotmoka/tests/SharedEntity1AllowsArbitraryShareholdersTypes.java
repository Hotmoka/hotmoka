 ...
 */
class SharedEntity1AllowsArbitraryShareholdersTypes extends TakamakaTest {
    private static final ClassType MY_CLASS = new ClassType("io.hotmoka.examples.sharedentities.MyClass");
    private static final ClassType SHARED_ENTITY_1 = new ClassType("io.hotmoka.examples.sharedentities.SharedEntity1");
    private static final ClassType SIMPLE_SHARED_ENTITY_1 = new ClassType("io.hotmoka.examples.sharedentities.SimpleSharedEntity1");
    private static final ClassType OFFER_1 = new ClassType(SHARED_ENTITY_1 + "$Offer");
    private static final ConstructorSignature MY_CLASS_CONSTRUCTOR = new ConstructorSignature(MY_CLASS);
    private static final ConstructorSignature SIMPLE_SHARED_ENTITY_1_CONSTRUCTOR = new ConstructorSignature(SIMPLE_SHARED_ENTITY_1, ClassType.PAYABLE_CONTRACT, ClassType.BIG_INTEGER);
    ...
    void acceptanceWithDifferentShareholderClassesWorks() throws SignatureException, TransactionException, CodeExecutionException, InvalidKeyException, TransactionRejectedException {
        ...
        StorageReference sharedEntity = addConstructorCallTransaction(privateKey(0), creator, _200_000, panarea(1), classpath,
                SIMPLE_SHARED_ENTITY_1_CONSTRUCTOR, sellerContractMyClass, new BigIntegerValue(BigInteger.TEN));
        ...
        StorageReference offer = (StorageReference) addInstanceMethodCallTransaction(privateKey(1), seller, _200_000, panarea(1), classpath,
                new NonVoidMethodSignature(MY_CLASS, "createOffer1", OFFER_1, ClassType.BIG_INTEGER, ClassType.BIG_INTEGER, LONG),
        ...
        addInstanceMethodCallTransaction(privateKey(1), seller, _200_000, panarea(1), classpath,
                new VoidMethodSignature(MY_CLASS, "placeOffer", SHARED_ENTITY_1, ClassType.BIG_INTEGER, OFFER_1),
        ...
        addInstanceMethodCallTransaction(privateKey(2), buyer, _200_000, panarea(1), classpath,
                new VoidMethodSignature(SIMPLE_SHARED_ENTITY_1, "accept", ClassType.BIG_INTEGER, OFFER_1),
