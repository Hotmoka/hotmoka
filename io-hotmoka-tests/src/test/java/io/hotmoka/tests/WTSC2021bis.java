...
class WTSC2021bis extends HotmokaTest {
    ...
    private final ClassType COIN = StorageTypes.of("io.hotmoka.examples.tokens.ExampleCoin");
    private final ConstructorSignature CONSTRUCTOR_OF_COIN = new ConstructorSignature(COIN);
    private final MethodSignature TRANSFER = new NonVoidMethodSignature(StorageTypes.IERC20, "transfer", BOOLEAN, StorageTypes.CONTRACT, BasicTypes.INT);
    private final ClassType CREATOR = StorageTypes.of("io.hotmoka.examples.tokens.ExampleCoinCreator");
    ...
    private final MethodSignature DISTRIBUTE = new VoidMethodSignature(CREATOR, "distribute", StorageTypes.ACCOUNTS, StorageTypes.IERC20, BasicTypes.INT);
