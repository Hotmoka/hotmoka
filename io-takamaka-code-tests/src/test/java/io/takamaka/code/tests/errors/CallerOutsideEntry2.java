...
class CallerOutsideEntry2 extends TakamakaTest {
	...
	void installJar() {
		throwsVerificationExceptionWithMessageContaining("caller() can only be used inside an @Entry",
			() -> addJarStoreTransaction(privateKey(0), account(0), _20_000, BigInteger.ONE, takamakaCode(), bytesOf("calleroutsideentry2.jar"), takamakaCode()));
	}
}