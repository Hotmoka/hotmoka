...
class IllegalCallToNonWhiteListedMethod4 extends TakamakaTest {
	...
	void beforeEach() throws Exception {
		setNode("illegalcalltononwhitelistedmethod4.jar", _1_000_000_000);
	}
	...
	void installJar() throws TransactionException, CodeExecutionException, IOException {
		throwsTransactionExceptionWithCause(NonWhiteListedCallException.class, () ->
			addStaticMethodCallTransaction(privateKey(0), account(0), _20_000, BigInteger.ONE, jar(),
				new NonVoidMethodSignature("io.takamaka.tests.errors.illegalcalltononwhitelistedmethod4.C", "foo", ClassType.STRING))
		);
	}
}