...
/**
 * The network message corresponding to {@link Node#addStaticMethodCallTransaction(StaticMethodCallTransactionRequest)}.
 */
@Immutable
public interface AddStaticMethodCallTransactionMessage extends RpcMessage {
