...
/**
 * The network message corresponding to {@link Node#addJarStoreTransaction(JarStoreTransactionRequest)}.
 */
@Immutable
public interface AddJarStoreTransactionMessage extends RpcMessage {
