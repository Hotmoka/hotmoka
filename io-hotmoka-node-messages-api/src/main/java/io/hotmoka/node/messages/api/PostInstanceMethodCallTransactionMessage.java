...
/**
 * The network message corresponding to {@link Node#postInstanceMethodCallTransaction(InstanceMethodCallTransactionRequest)}.
 */
@Immutable
public interface PostInstanceMethodCallTransactionMessage extends RpcMessage {
