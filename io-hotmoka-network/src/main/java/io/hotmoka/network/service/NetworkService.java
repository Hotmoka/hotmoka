...
import io.hotmoka.network.util.NodeFunction;
...
public class NetworkService {
    ...
    /**
     * Map function to map the {@link io.hotmoka.nodes.Node} into a {@link org.springframework.http.ResponseEntity} through the use of a {@link io.hotmoka.network.util.NodeFunction}
