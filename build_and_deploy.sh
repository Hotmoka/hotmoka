...
# jars in your local Maven repository, then will deploy the artifacts to
# Maven Central. Change the value for JAVA_HOME
...
JAVA_HOME=/usr/lib/jvm/default-java mvn clean deploy -DskipTests -Drestricted
