...
public abstract class PostInstanceMethodCallTransactionResultMessageJson extends AbstractRpcMessageJsonRepresentation<PostInstanceMethodCallTransactionResultMessage> {
	...
	@Override
	public PostInstanceMethodCallTransactionResultMessage unmap() throws HexConversionException {
		return PostInstanceMethodCallTransactionResultMessages.of(result.unmap(), getId());
	}
