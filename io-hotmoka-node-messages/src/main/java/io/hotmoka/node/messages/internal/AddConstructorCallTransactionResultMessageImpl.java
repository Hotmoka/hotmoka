...
public class AddConstructorCallTransactionResultMessageImpl extends AbstractRpcMessage implements AddConstructorCallTransactionResultMessage {
	 ...
	 */
	private <E extends Exception> AddConstructorCallTransactionResultMessageImpl(StorageReference result, String id, ExceptionSupplierFromMessage<? extends E> onIllegalArgs) throws E {
