 ...
 */
public abstract class AddJarStoreTransactionResultMessageJson extends AbstractRpcMessageJsonRepresentation<AddJarStoreTransactionResultMessage> {
	private final TransactionReferences.Json result;

	protected AddJarStoreTransactionResultMessageJson(AddJarStoreTransactionResultMessage message) {
		super(message);
