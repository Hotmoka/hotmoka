 ...
 */
public abstract class AddInitializationTransactionMessageJson extends AbstractRpcMessageJsonRepresentation<AddInitializationTransactionMessage> {
	private final TransactionRequests.Json request;

	protected AddInitializationTransactionMessageJson(AddInitializationTransactionMessage message) {
		super(message);
	...
	public AddInitializationTransactionMessage unmap() throws InconsistentJsonException {
		return new AddInitializationTransactionMessageImpl(this);
	}
