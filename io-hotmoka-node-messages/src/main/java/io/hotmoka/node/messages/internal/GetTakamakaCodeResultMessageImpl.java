...
public class GetTakamakaCodeResultMessageImpl extends AbstractRpcMessage implements GetTakamakaCodeResultMessage {
	 ...
	 */
	public GetTakamakaCodeResultMessageImpl(GetTakamakaCodeResultMessageJson json) throws InconsistentJsonException {
		this(
	 ...
	 */
	private <E extends Exception> GetTakamakaCodeResultMessageImpl(TransactionReference result, String id, ExceptionSupplierFromMessage<? extends E> onIllegalArgs) throws E {
