...
public class RunInstanceMethodCallTransactionResultMessageImpl extends AbstractRpcMessage implements RunInstanceMethodCallTransactionResultMessage {
	 ...
	 */
	private <E extends Exception> RunInstanceMethodCallTransactionResultMessageImpl(Optional<StorageValue> result, String id, ExceptionSupplierFromMessage<? extends E> onIllegalArgs) throws E {
