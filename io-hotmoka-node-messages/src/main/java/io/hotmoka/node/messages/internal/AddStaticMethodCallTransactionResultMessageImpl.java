...
public class AddStaticMethodCallTransactionResultMessageImpl extends AbstractRpcMessage implements AddStaticMethodCallTransactionResultMessage {
	 ...
	 */
	private <E extends Exception> AddStaticMethodCallTransactionResultMessageImpl(Optional<StorageValue> result, String id, ExceptionSupplier<? extends E> onIllegalArgs) throws E {
