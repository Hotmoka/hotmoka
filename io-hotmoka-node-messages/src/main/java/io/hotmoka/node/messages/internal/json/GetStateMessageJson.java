 ...
 */
public abstract class GetStateMessageJson extends AbstractRpcMessageJsonRepresentation<GetStateMessage> {
	private final StorageValues.Json reference;

	protected GetStateMessageJson(GetStateMessage message) {
		super(message);
	...
	public GetStateMessage unmap() throws InconsistentJsonException {
		return new GetStateMessageImpl(this);
	}
