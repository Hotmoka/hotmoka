 ...
 */
public abstract class GetPolledResponseMessageJson extends AbstractRpcMessageJsonRepresentation<GetPolledResponseMessage> {
	private final TransactionReferences.Json reference;

	protected GetPolledResponseMessageJson(GetPolledResponseMessage message) {
		super(message);
	...
	public GetPolledResponseMessage unmap() throws InconsistentJsonException {
		return new GetPolledResponseMessageImpl(this);
	}
