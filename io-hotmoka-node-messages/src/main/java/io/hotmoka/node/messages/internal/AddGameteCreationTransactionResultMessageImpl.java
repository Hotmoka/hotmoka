...
public class AddGameteCreationTransactionResultMessageImpl extends AbstractRpcMessage implements AddGameteCreationTransactionResultMessage {
	 ...
	 */
	private <E extends Exception> AddGameteCreationTransactionResultMessageImpl(StorageReference result, String id, ExceptionSupplierFromMessage<? extends E> onIllegalArgs) throws E {
