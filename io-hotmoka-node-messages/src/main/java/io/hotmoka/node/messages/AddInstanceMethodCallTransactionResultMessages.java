...
public abstract class AddInstanceMethodCallTransactionResultMessages {
	 ...
	 * Gson encoder.
	 */
	public static class Encoder extends MappedEncoder<AddInstanceMethodCallTransactionResultMessage, Json> {
	 ...
	 * Gson decoder.
	 */
	public static class Decoder extends MappedDecoder<AddInstanceMethodCallTransactionResultMessage, Json> {
