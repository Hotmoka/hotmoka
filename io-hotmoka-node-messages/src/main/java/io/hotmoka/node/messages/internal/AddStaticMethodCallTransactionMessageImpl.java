 ...
 */
public class AddStaticMethodCallTransactionMessageImpl extends AbstractRpcMessage implements AddStaticMethodCallTransactionMessage {
	 ...
	 */
	private <E extends Exception> AddStaticMethodCallTransactionMessageImpl(StaticMethodCallTransactionRequest request, String id, ExceptionSupplierFromMessage<? extends E> onIllegalArgs) throws E {
	...
	public boolean equals(Object other) {
		return other instanceof AddStaticMethodCallTransactionMessage asmctm && super.equals(other) && request.equals(asmctm.getRequest());
	}
