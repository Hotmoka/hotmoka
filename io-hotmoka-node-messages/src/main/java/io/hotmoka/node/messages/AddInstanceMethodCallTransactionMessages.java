...
public abstract class AddInstanceMethodCallTransactionMessages {
	 ...
	 * Gson encoder.
	 */
	public static class Encoder extends MappedEncoder<AddInstanceMethodCallTransactionMessage, Json> {
	 ...
	 * Gson decoder.
	 */
	public static class Decoder extends MappedDecoder<AddInstanceMethodCallTransactionMessage, Json> {
