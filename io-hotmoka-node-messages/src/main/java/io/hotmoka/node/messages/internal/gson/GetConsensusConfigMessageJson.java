 ...
 */
public abstract class GetConsensusConfigMessageJson extends AbstractRpcMessageJsonRepresentation<GetConsensusConfigMessage> {

	protected GetConsensusConfigMessageJson(GetConsensusConfigMessage message) {
		super(message);
	}
