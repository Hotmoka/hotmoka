...
import io.hotmoka.node.messages.internal.json.AddInstanceMethodCallTransactionResultMessageJson;
...
public class AddInstanceMethodCallTransactionResultMessageImpl extends AbstractRpcMessage implements AddInstanceMethodCallTransactionResultMessage {
	 ...
	 */
	public AddInstanceMethodCallTransactionResultMessageImpl(AddInstanceMethodCallTransactionResultMessageJson json) throws InconsistentJsonException {
	 ...
	 */
	private <E extends Exception> AddInstanceMethodCallTransactionResultMessageImpl(Optional<StorageValue> result, String id, ExceptionSupplierFromMessage<? extends E> onIllegalArgs) throws E {
	...
	private static Optional<StorageValue> unmapResult(AddInstanceMethodCallTransactionResultMessageJson json) throws InconsistentJsonException {
