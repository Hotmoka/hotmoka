...
public class PostInstanceMethodCallTransactionResultMessageImpl extends AbstractRpcMessage implements PostInstanceMethodCallTransactionResultMessage {
	 ...
	 */
	private <E extends Exception> PostInstanceMethodCallTransactionResultMessageImpl(TransactionReference result, String id, ExceptionSupplierFromMessage<? extends E> onIllegalArgs) throws E {
