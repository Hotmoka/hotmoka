...
public class PostJarStoreTransactionResultMessageImpl extends AbstractRpcMessage implements PostJarStoreTransactionResultMessage {
	 ...
	 */
	private <E extends Exception> PostJarStoreTransactionResultMessageImpl(TransactionReference result, String id, ExceptionSupplier<? extends E> onIllegalArgs) throws E {
