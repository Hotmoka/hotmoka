...
public class GetPolledResponseResultMessageImpl extends AbstractRpcMessage implements GetPolledResponseResultMessage {
	 ...
	 */
	public GetPolledResponseResultMessageImpl(GetPolledResponseResultMessageJson json) throws InconsistentJsonException {
		this(
	 ...
	 */
	private <E extends Exception> GetPolledResponseResultMessageImpl(TransactionResponse result, String id, ExceptionSupplierFromMessage<? extends E> onIllegalArgs) throws E {
