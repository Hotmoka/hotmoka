...
public class AddConstructorCallTransactionMessageImpl extends AbstractRpcMessage implements AddConstructorCallTransactionMessage {
	 ...
	 */
	private <E extends Exception> AddConstructorCallTransactionMessageImpl(ConstructorCallTransactionRequest request, String id, ExceptionSupplier<? extends E> onIllegalArgs) throws E {
