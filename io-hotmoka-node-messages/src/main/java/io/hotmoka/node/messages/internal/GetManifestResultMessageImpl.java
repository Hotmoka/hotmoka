...
public class GetManifestResultMessageImpl extends AbstractRpcMessage implements GetManifestResultMessage {
	 ...
	 */
	public GetManifestResultMessageImpl(GetManifestResultMessageJson json) throws InconsistentJsonException {
	 ...
	 */
	private <E extends Exception> GetManifestResultMessageImpl(StorageReference result, String id, ExceptionSupplierFromMessage<? extends E> onIllegalArgs) throws E {
	...
	private static StorageReference unmapResult(GetManifestResultMessageJson json) throws InconsistentJsonException {
