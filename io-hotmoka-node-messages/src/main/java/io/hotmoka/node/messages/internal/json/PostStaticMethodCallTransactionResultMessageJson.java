 ...
 */
public abstract class PostStaticMethodCallTransactionResultMessageJson extends AbstractRpcMessageJsonRepresentation<PostStaticMethodCallTransactionResultMessage> {
	private final TransactionReferences.Json result;

	protected PostStaticMethodCallTransactionResultMessageJson(PostStaticMethodCallTransactionResultMessage message) {
		super(message);
	...
	public PostStaticMethodCallTransactionResultMessage unmap() throws InconsistentJsonException {
		return new PostStaticMethodCallTransactionResultMessageImpl(this);
	}
