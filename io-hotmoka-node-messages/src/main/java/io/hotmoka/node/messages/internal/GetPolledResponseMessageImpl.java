...
public class GetPolledResponseMessageImpl extends AbstractRpcMessage implements GetPolledResponseMessage {
	 ...
	 */
	public GetPolledResponseMessageImpl(GetPolledResponseMessageJson json) throws InconsistentJsonException {
		this(
	 ...
	 */
	private <E extends Exception> GetPolledResponseMessageImpl(TransactionReference reference, String id, ExceptionSupplierFromMessage<? extends E> onIllegalArgs) throws E {
