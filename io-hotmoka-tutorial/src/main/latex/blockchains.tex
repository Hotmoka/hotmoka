...
%
\input{docker_create_keys_for_mining_command}
\input{docker_create_keys_for_mining_output}
%
\begin{commentbox}
...
\input{docker_config_miner_command}
%
...
\input{docker_check_balance_command}
%
...
%
\input{docker_mokamint_config_clone_command}
%
...
%
\input{docker_mokamint_go_command}
%
...
%
\input{docker_create_keys_for_mokamint_gamete_command}
\input{docker_create_keys_for_mokamint_gamete_output}
%
You can now configure the node, by specifying the public key of the miner and that of the gamete:
%
\input{docker_mokamint_config_new_command}
%
...
%
\input{docker_mokamint_init_command}
%
...
%
\input{docker_tendermint_config_clone_command}
%
...
After configuring the node, you can run it with the go script:
%
\input{docker_tendermint_go_command}
%
...
\subsection{Start a node of a new blockchain}\label{subsec:start_hotmoka_mokamint}
...
\texttt{gamete.pem} as well:
%
\input{docker_create_keys_for_tendermint_gamete_command}
\input{docker_create_keys_for_tendermint_gamete_output}
%
You can now configure the node, by specifying the public key of the gamete:
%
\input{docker_tendermint_config_new_command}
%
...
that create the genesis block, the manifest and the gas station of the node. You can do this with:
%
\input{docker_tendermint_init_command}
%
This will take a few seconds. You should see the logs of the executed transactions,
until the script terminates.
