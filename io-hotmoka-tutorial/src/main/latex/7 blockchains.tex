...
\texttt{moka accounts send \gameteShort{} 1000 \manifestShort{} --uri \serverMokamint{} --password-of-payer}\index{moka@{\texttt{moka}}!accounts send@{\texttt{accounts send}}}.
Note that you must be able to control the sender for that (you need \texttt{\gameteShort{}.pem}),
but you do not need control of the receiver (you don't need \texttt{\manifestShort{}.pem}).
