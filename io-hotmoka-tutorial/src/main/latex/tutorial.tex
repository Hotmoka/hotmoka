...
\fancyhead[L]{\includegraphics[width=1.5cm]{pics/hotmoka_logo}}
...
\input{parameters_mokamint.tex}
\input{parameters_tendermint.tex}
\input{parameters_quantum_mokamint.tex}
...
\date{\today\\{\small (updated to Hotmoka \hotmokaVersion{}, Mokamint \mokamintVersion{} and Takamaka \takamakaVersion{})} \\
  ...
  {\small\begin{minipage}{\textwidth*4/5}
    \begin{center}\includegraphics[width=11ex]{pics/CC_license}\end{center}
...
\HTMLFirstPageTop{\begin{center}\includegraphics[width=10cm]{pics/hotmoka_logo}\end{center}}
\HTMLPageTop{\begin{center}\includegraphics[width=7cm]{pics/hotmoka_logo}\end{center}}
...
\newcommand{\leftplug}{\includegraphics[width=0.7cm]{pics/plug_left}}
\newcommand{\rightplug}{\includegraphics[width=0.7cm]{pics/plug_right}}
\newcommand{\ssd}{\includegraphics[width=0.8cm]{pics/ssd}}
...
\input{first_takamaka_program}
\input{smart_contracts}
\input{support_library}
\input{tokens}
\input{blockchains}
\input{nodes}
\input{code_verification}
