...
\newmdenv[linecolor=black,leftmargin=2em,rightmargin=2em,innertopmargin=1em,innerbottommargin=1em,backgroundcolor={shellboxbackgroundcolor}]{shellboxmd}

\newenvironment{shellbox}{\begin{alltt}\small}{\end{alltt}}
