...
\DeclareUrlCommand\website{\urlstyle{tt}}
...
\date{\today\\{\small (updated to Hotmoka \hotmokaVersion{}, Mokamint \mokamintVersion{} and Takamaka \takamakaVersion{})} \\
  ...
  {\small\begin{minipage}{\textwidth*4/5}
    ...
    Its latest version is available for free online
	at \hotmokaTutorialOnline{} and in PDF at \hotmokaRepoReleases{}.
  \end{minipage}}
}
...
\newcommand{\db}{\myincludegraphics{1.3cm}{db}}
...
\newcommand{\interfacecolor}{\renewcommand{\umlfillcolor}{lightviolet}}
\newcommand{\classcolor}{\renewcommand{\umlfillcolor}{lightblue}}

% the color of a UML class defined in our examples
\newcommand{\ourclasscolor}{\renewcommand{\umlfillcolor}{lightgreen}}

% the color of a UML class external to the hierarchy being described
\newcommand{\externalclasscolor}{\renewcommand{\umlfillcolor}{white}}

\newcommand{\packagecolor}{\renewcommand{\umlfillcolor}{verylightgray}}
