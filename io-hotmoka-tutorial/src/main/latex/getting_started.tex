...
\begin{figure}
  \begin{center}
    \begin{tikzpicture}[scale=0.5,>=Stealth]
      ...
      \draw (1,18) node[right] {jar: basic Takamaka classes};
      \draw (1,17) node[right] {including \ldots\texttt{ExternallyOwnedAccountED25519}};
      \draw (-2,17.5) node[left] {at \texttt{\takamakaCodeShort{}\ldots}};
      ...
      \draw (1,1.3) node[right] {publicKey: \texttt{\accountOnePublicKeyBaseSixtyfourShort{}\ldots}};

      \draw[->,thick] (17,4.8) -- +(0,11.2);
      \draw (17,12) node[left] {classpath};

      \draw (-2,3) node[left] {payer (account)};
      \draw (-2,2) node[left] {at \texttt{\accountOneShort{}\ldots}};
...
\section{Contacting a Hotmoka test node}\label{sec:contacting_test_node}
...
\texttt{\serverMokamint{}} and \texttt{\serverTendermint{}}.
