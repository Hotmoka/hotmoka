...
Since this is a test network, we can more simply use the faucet of the gamete instead,
that is willing
...
inside a \texttt{\hotmokaTutorialDir} directory of your home, so that \texttt{moka}
will save the key pair of your account
there, which will simplify your subsequent work:
%
\input{moka_keys_create_account1_command}
...
%
\input{moka_accounts_create_account1_command}
