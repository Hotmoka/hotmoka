...
\begin{figure}
  \begin{center}
    \begin{tikzpicture}[scale=0.5,>=Stealth]
      \draw[rounded corners] (0,0) rectangle (12,13) [fill=statebackgroundcolor];

      \draw[rounded corners] (0.5,9.5) rectangle +(11,2.8) [fill=jarbackgroundcolor];
      \draw (1,10.9) node[right] {jar (code of the methods)};

      \draw[->,thick] (6,6.8) -- +(0,2.7);
      \draw (6,8.2) node[left] {classpath};

      \draw[rounded corners] (0.5,4) rectangle +(11,2.8) [fill=objectbackgroundcolor];
      \draw (1,5.4) node[right] {class tag: \texttt{Person.class}};
      \draw (-2,5.4) node[left] {receiver};
      \draw[->,thick] (-2,5.4) -- +(2.5,0);

      \draw[rounded corners] (0.5,0.5) rectangle +(11,3) [fill=objectbackgroundcolor];
      \draw (1,2.6) node[right] {balance: 3432\ldots};
      \draw (1,1.3) node[right] {publicKey: \texttt{\accountOneShortPublicKey}};
      \draw (-2,2.5) node[left] {payer (account)};
      \draw (-2,1.5) node[left] {at \texttt{\accountOneShort}};
...
%
\begin{center}
\verb|docker run -it --rm hotmoka/mokamint-node:|\texttt{\hotmokaVersion{}}\verb| moka --version|
\end{center}
%
...
allocated at a given storage reference, such as:
%
\begin{warpprint}
\begin{center}
\verb|docker run -it --rm hotmoka/mokamint-node:|\texttt{\hotmokaVersion{}}\verb| moka objects show |\linebreak\texttt{\accountOne{}} \verb|--uri ws://panarea.hotmoka.io:8001|
\end{center}
\end{warpprint}
%
\begin{warpHTML}
\begin{center}
\verb|docker run -it --rm hotmoka/mokamint-node:|\texttt{\hotmokaVersion{}}\verb| moka objects show |\texttt{\accountOne{}} \verb|--uri ws://panarea.hotmoka.io:8001|
\end{center}
\end{warpHTML}
%
The output will be something like:\mbox{}\\

\begin{warpprint}
\noindent
\verb|class io.takamaka.code.lang.ExternallyOwnedAccountED25519 (from jar installed|

\noindent
\verb|  at 0d0f8f8232e4931a7f2f2e0fae7c5f63c6c31d35b1fcd22494e7c3a21fb8d2af)|

\noindent
\verb|  io.takamaka.code.lang.Contract.balance:java.math.BigInteger = 50000000000000|

\noindent
\verb|  io.takamaka.code.lang.ExternallyOwnedAccount.nonce:java.math.BigInteger = 0|

\noindent
\verb|  io.takamaka.code.lang.ExternallyOwnedAccount.publicKey:java.lang.String|

\noindent
\verb|    = "BUyu8cMDPlkNWtrkxNRYmzuK+vUFmiTJfA7ikGiK6Fw="|
\end{warpprint}
%
\begin{warpHTML}
\texttt{class io.takamaka.code.lang.ExternallyOwnedAccountED25519 (from jar installed
  at 0d0f8f8232e4931a7f2f2e0fae7c5f63c6c31d35b1fcd22494e7c3a21fb8d2af)
  ...
  io.takamaka.code.lang.ExternallyOwnedAccount.publicKey:java.lang.String
    = "BUyu8cMDPlkNWtrkxNRYmzuK+vUFmiTJfA7ikGiK6Fw="}
\end{warpHTML}
