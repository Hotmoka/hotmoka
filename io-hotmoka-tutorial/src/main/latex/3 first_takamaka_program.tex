...
%
\inputCommand{moka_jars_install}\index{moka!jars install@{\texttt{jars install}}}\index{jar!install}
...
new \texttt{Person} object into the store of the node. We can perform this through the moka tool:\index{moka!objects create@{\texttt{objects create}}}
%
...
Install this new version in blockchain:\index{moka!jars install@{\texttt{jars install}}}
%
...
complete without exception:\index{moka!objects create@{\texttt{objects create}}}
%
...
by using the \texttt{moka objects show} command:\index{moka!objects show@{\texttt{objects show}}}
%
