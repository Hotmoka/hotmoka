...
\begin{figure}[th]
  \begin{center}
    \myincludegraphics{0.45\textwidth}{lists}
  \end{center}
...
and class
\texttt{SnapshottableStorageTreeArray<E>}\index{SnapshottableStorageTreeArray@{\texttt{StorageTreeArray}}}, whose
instances are storage objects and
can consequently be held in fields of storage classes and
...
\begin{figure}[th]
  \begin{center}
	...
	\begin{interface}[text width=5.2cm]{SnapshottableStorageArray\string<E\string>}{4.5,-9}
		...
		\operation{view():SnapshottableStorageArray\string<E\string>}
	\end{interface}
	\externalclasscolor
...
\begin{figure}[th]
  \begin{center}
    \myincludegraphics{0.45\textwidth}{maps}
  \end{center}
