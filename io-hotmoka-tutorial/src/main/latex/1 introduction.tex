...
\multirow{3}{*}{Mokamint test network} & \multirow{3}{*}{\texttt{\serverMokamintChainId{}}} & Hotmoka node & \serverMokamint{} \\\cline{3-4}
\mrowcell                              & \mrowcell                                          & Mokamint node & \serverMokamintPublic{} \\\cline{3-4}
\mrowcell                              & \mrowcell                                          & Mokamint mining & \serverMokamintMining{} \\\hline\hline
\multirow{3}{*}{Mokamint main network} & \multirow{3}{*}{\texttt{\serverMokamintMainChainId{}}} & Hotmoka node & \serverMokamintMain{} \\\cline{3-4}
\mrowcell                              & \mrowcell                                              & Mokamint node & \serverMokamintMainPublic{} \\\cline{3-4}
\mrowcell                              & \mrowcell                                              & Mokamint mining & \serverMokamintMainMining{} \\\hline\hline
\multirow{2}{*}{Tendermint test network} & \multirow{2}{*}{\texttt{\serverTendermintChainId{}}} & Hotmoka node & \serverTendermint{} \\\cline{3-4}
\mrowcell                                & \mrowcell                                            & Tendermint whisper & \serverTendermintWhisper{} \\\hline
\end{tabular}
\end{center}
