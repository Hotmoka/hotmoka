...
traditional array (see Sec.~\ref{subsec:specialized-storage-array-classes}).
...
%
\index{moka!keys create@{\texttt{keys create}}}
\input{moka_keys_create_account4_command}
\input{moka_keys_create_account4_output}
%
\input{moka_keys_create_account5_command}
\input{moka_keys_create_account5_output}
%
\input{moka_keys_create_account6_command}
\input{moka_keys_create_account6_output}
%
\index{moka!accounts create@{\texttt{accounts create}}}
\input{moka_accounts_create_account4_command}
\input{moka_accounts_create_account4_output}
%
\input{moka_accounts_create_account5_command}
\input{moka_accounts_create_account5_output}
%
\input{moka_accounts_create_account6_command}
\input{moka_accounts_create_account6_output}
...
%
\input{mvn_exec_blind_auction_command}
%
Its execution should print something like this on the console:
%
\input{mvn_exec_blind_auction_output}
...
%
\input{mvn_exec_blind_auction_events_command}
%
You should see something like this on the console:
%
\input{mvn_exec_blind_auction_events_output}
%
\begin{commentbox}
