...
%
The new object has been allocated at a storage reference \texttt{\personObejctShort{}}
...
to generate a Java \texttt{BigInteger} corresponding to the smallest coin unit of Hotmoka nodes,
a \emph{panarea}.
...
%
The exact address where the \texttt{Person} object gets alocated will change at each run.
