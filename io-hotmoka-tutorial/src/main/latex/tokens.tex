...
\input{moka_jars_install_erc20_command}
\input{moka_jars_install_erc20_output}
%
...
\input{moka_objects_create_erc20_command}
\input{moka_objects_create_erc20_output}
%
...
\begin{figure}[th]
  \begin{center}
    \includegraphics[width=0.65\textwidth]{pics/erc721}
  \end{center}
