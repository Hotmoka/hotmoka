...
[Markdownonly]: <p align="center"><img width="300" src="pics/runs.png" alt="Figure @fig:runs. The `runs` Eclipse project"></p><p align="center">Figure @fig:runs. The `runs` Eclipse project.</p>
...
public class Family {
  ...
  public static void main(String[] args) throws Exception {
    ...
    try (var node = RemoteNodes.of(URI.create("@server"), 20000)) {
      // we get a reference to where io-takamaka-code-@takamaka_version.jar has been stored
