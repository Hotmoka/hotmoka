...
public class ManifestHelperImpl implements ManifestHelper {
	 ...
	 */
	public ManifestHelperImpl(Node node) throws TimeoutException, InterruptedException, TransactionRejectedException, TransactionException, CodeExecutionException, UninitializedNodeException, UnexpectedCodeException, ClosedNodeException {
		this.node = node;
