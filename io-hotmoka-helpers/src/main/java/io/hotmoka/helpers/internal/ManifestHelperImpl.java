	...
	public ManifestHelperImpl(Node node) throws NodeException, TimeoutException, InterruptedException, TransactionRejectedException, TransactionException {
		...
		try {
			...
			this.initialValidators = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
					(manifest, _100_000, takamakaCode, MethodSignatures.GET_INITIAL_VALIDATORS, manifest, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			this.gasStation = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
					(manifest, _100_000, takamakaCode, MethodSignatures.GET_GAS_STATION, manifest, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			this.versions = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
					(manifest, _100_000, takamakaCode, MethodSignatures.GET_VERSIONS, manifest, StorageValues.EMPTY, IllegalArgumentException::new))
	...
	public String toString() {
		...
		try {
			...
			String genesisTime = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(gamete, _100_000, takamakaCode, MethodSignatures.GET_GENESIS_TIME, manifest, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			int maxErrorLength = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall // TODO: avoid casts
				(manifest, _100_000, takamakaCode, MethodSignatures.GET_MAX_ERROR_LENGTH, manifest, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			int maxDependencies = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.GET_MAX_DEPENDENCIES, manifest, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			long maxCumulativeSizeOfDependencies = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.GET_MAX_CUMULATIVE_SIZE_OF_DEPENDENCIES, manifest, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			boolean allowsUnsignedFaucet = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.ALLOWS_UNSIGNED_FAUCET, manifest, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			boolean skipsVerification = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.SKIPS_VERIFICATION, manifest, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			String signature = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.GET_SIGNATURE, manifest, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			BigInteger balanceOfGamete = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.BALANCE, gamete, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			BigInteger maxFaucet = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.GET_MAX_FAUCET, gamete, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			BigInteger initialGasPrice = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.GET_INITIAL_GAS_PRICE, gasStation, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			BigInteger gasPrice = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.GET_GAS_PRICE, gasStation, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			BigInteger maxGasPerTransaction = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.GET_MAX_GAS_PER_TRANSACTION, gasStation, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			boolean ignoresGasPrice = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.IGNORES_GAS_PRICE, gasStation, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			BigInteger targetGasAtReward = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.GET_TARGET_GAS_AT_REWARD, gasStation, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			long oblivion = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.GET_OBLIVION, gasStation, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			StorageReference shares;
			{
				...
				shares = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
						(manifest, _100_000, takamakaCode, method, validators, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			int numOfValidators = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
					(manifest, _100_000, takamakaCode, MethodSignatures.STORAGE_MAP_VIEW_SIZE, shares, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			int numOfOffers = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
					(manifest, _100_000, takamakaCode, MethodSignatures.STORAGE_SET_VIEW_SIZE, offers, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			int slashingForMisbehaving;
			{
				...
				slashingForMisbehaving = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall(manifest, _100_000, takamakaCode, method, validators, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			int slashingForNotBehaving = ((IntValue) node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.ofNonVoid(StorageTypes.VALIDATORS, "getSlashingForNotBehaving", StorageTypes.INT), validators, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			int percentStaked = ((IntValue) node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.ofNonVoid(StorageTypes.VALIDATORS, "getPercentStaked", StorageTypes.INT), validators, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			for (int num = 0; num < numOfOffers; num++) {
				...
				var seller = (StorageReference) node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
					(manifest, _100_000, takamakaCode, MethodSignatures.ofNonVoid(StorageTypes.SHARED_ENTITY_OFFER, "getSeller", StorageTypes.PAYABLE_CONTRACT), offer, StorageValues.EMPTY, IllegalArgumentException::new))
				...
				boolean isOngoing;
				{
					...
					isOngoing = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall(manifest, _100_000, takamakaCode, method, offer, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			for (int num = 0; num < numOfValidators; num++) {
				...
				String id = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
					(manifest, _100_000, takamakaCode, MethodSignatures.ID, validator, StorageValues.EMPTY, IllegalArgumentException::new))
				...
				BigInteger balanceOfValidator = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
					(manifest, _100_000, takamakaCode, MethodSignatures.BALANCE, validator, StorageValues.EMPTY, IllegalArgumentException::new))
					.orElseThrow(() -> new NodeException(MethodSignatures.BALANCE + " should not return void"))
					.asReturnedBigInteger(MethodSignatures.BALANCE, NodeException::new);
				...
				if (saleOffers == null)
					...
					for (StorageReference offer: saleOffers) {
						...
						BigInteger powerOnSale = ((BigIntegerValue) node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
							(manifest, _100_000, takamakaCode, MethodSignatures.ofNonVoid(StorageTypes.SHARED_ENTITY_OFFER, "getSharesOnSale", StorageTypes.BIG_INTEGER), offer, StorageValues.EMPTY, IllegalArgumentException::new))
						...
						Date expiration;
						{
							...
							expiration = new Date(node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall(manifest, _100_000, takamakaCode, method, offer, StorageValues.EMPTY, IllegalArgumentException::new))
								.orElseThrow(() -> new NodeException(method + " should not return void"))
						...
						StorageValue buyer = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
							(manifest, _100_000, takamakaCode, MethodSignatures.ofNonVoid(StorageTypes.SHARED_ENTITY_OFFER, "getBuyer", StorageTypes.PAYABLE_CONTRACT), offer, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			BigInteger initialSupply = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.GET_INITIAL_SUPPLY, validators, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			BigInteger currentSupply = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.GET_CURRENT_SUPPLY, validators, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			BigInteger finalSupply = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.GET_FINAL_SUPPLY, validators, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			long initialInflation = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.GET_INITIAL_INFLATION, validators, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			long currentInflation = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.GET_CURRENT_INFLATION, validators, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			BigInteger height = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.GET_HEIGHT, validators, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			BigInteger numberOfTransactions = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.GET_NUMBER_OF_TRANSACTIONS, validators, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			BigInteger ticketForNewPoll = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.GET_TICKET_FOR_NEW_POLL, validators, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			StorageReference polls = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.GET_POLLS, validators, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			int numOfPolls = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.STORAGE_SET_VIEW_SIZE, polls, StorageValues.EMPTY, IllegalArgumentException::new))
				.orElseThrow(() -> new NodeException(MethodSignatures.STORAGE_SET_VIEW_SIZE + " should not return void"))
				.asReturnedInt(MethodSignatures.STORAGE_SET_VIEW_SIZE, NodeException::new);
			...
			for (int num = 0; num < numOfPolls; num++) {
				...
				String description = ((StringValue) node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
					(manifest, _100_000, takamakaCode, MethodSignatures.ofNonVoid(StorageTypes.POLL, "getDescription", StorageTypes.STRING), poll, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			shares = (StorageReference) node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.ofNonVoid(StorageTypes.SHARED_ENTITY_VIEW, "getShares", StorageTypes.STORAGE_MAP_VIEW), initialValidators, StorageValues.EMPTY, IllegalArgumentException::new))
			...
			long verificationVersion = node.runInstanceMethodCallTransaction(TransactionRequests.instanceViewMethodCall
				(manifest, _100_000, takamakaCode, MethodSignatures.GET_VERIFICATION_VERSION, versions, StorageValues.EMPTY, IllegalArgumentException::new))
