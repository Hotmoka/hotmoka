 ...
 */
public class AddGasUpdates extends ClassInstrumentation.Builder.MethodLevelInstrumentation {
	...
	public AddGasUpdates(ClassInstrumentation.Builder builder, MethodGen method) {
	...
	private void addRamGasUpdate(InstructionHandle ih, InstructionList il, CodeExceptionGen[] ceg) {
		...
		if (bytecode instanceof InvokeInstruction) {
			...
			MethodGen allocator = new MethodGen(ClassInstrumentation.PRIVATE_SYNTHETIC_STATIC, createdType, args, null, allocatorName, className, allocatorIl, cpg);
