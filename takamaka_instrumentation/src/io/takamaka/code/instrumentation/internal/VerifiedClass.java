...
import io.takamaka.code.instrumentation.internal.checksOnClass.BootstrapsAreLegalCheck;
import io.takamaka.code.instrumentation.internal.checksOnClass.EntriesAreOnlyCalledFromContractsCheck;
import io.takamaka.code.instrumentation.internal.checksOnClass.PackagesAreLegalCheck;
import io.takamaka.code.instrumentation.internal.checksOnClass.StorageClassesHaveFieldsOfStorageTypeCheck;
import io.takamaka.code.instrumentation.internal.checksOnMethods.BytecodesAreLegalCheck;
import io.takamaka.code.instrumentation.internal.checksOnMethods.CallerIsUsedOnThisAndInEntryCheck;
import io.takamaka.code.instrumentation.internal.checksOnMethods.EntryCodeIsConsistentWithClassHierarchyCheck;
import io.takamaka.code.instrumentation.internal.checksOnMethods.EntryCodeIsInstanceAndInContractsCheck;
import io.takamaka.code.instrumentation.internal.checksOnMethods.ExceptionHandlersAreForCheckedExceptionsCheck;
import io.takamaka.code.instrumentation.internal.checksOnMethods.IsNotNativeCheck;
import io.takamaka.code.instrumentation.internal.checksOnMethods.IsNotStaticInitializerCheck;
import io.takamaka.code.instrumentation.internal.checksOnMethods.IsNotSynchronizedCheck;
import io.takamaka.code.instrumentation.internal.checksOnMethods.PayableCodeIsConsistentWithClassHierarchyCheck;
import io.takamaka.code.instrumentation.internal.checksOnMethods.PayableCodeIsEntryCheck;
import io.takamaka.code.instrumentation.internal.checksOnMethods.PayableCodeReceivesAmountCheck;
import io.takamaka.code.instrumentation.internal.checksOnMethods.ThrowsExceptionsCodeIsPublicCheck;
import io.takamaka.code.instrumentation.internal.checksOnMethods.ThrowsExceptionsIsConsistentWithClassHierarchyCheck;
import io.takamaka.code.instrumentation.internal.checksOnMethods.UsedCodeIsWhiteListedCheck;
	...
	public class ClassVerification {
		...
		public abstract class Check {
			...
			protected final void issue(Issue issue) {
				...
				hasErrors |= issue instanceof io.takamaka.code.instrumentation.issues.Error;
			}
