...
class CallerOutsideEntry extends TakamakaTest {
	...
	void installJar() {
		throwsVerificationExceptionWithCause(CallerOutsideEntryError.class, () ->
			blockchain.addJarStoreTransaction
				...
				Files.readAllBytes(Paths.get("../io-takamaka-examples/target/io-takamaka-examples-1.0-calleroutsideentry.jar")), blockchain.takamakaCode()))
		);
	}
}