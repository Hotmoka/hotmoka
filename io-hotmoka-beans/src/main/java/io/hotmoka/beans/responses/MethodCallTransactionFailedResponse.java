 ...
 */
@Immutable
public class MethodCallTransactionFailedResponse extends MethodCallTransactionResponseImpl implements MethodCallTransactionResponse, FailedTransactionResponse {
