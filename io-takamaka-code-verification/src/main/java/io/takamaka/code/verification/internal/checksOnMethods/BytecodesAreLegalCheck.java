 ...
 */
public class BytecodesAreLegalCheck extends VerifiedClassImpl.Builder.MethodVerification.Check {

	public BytecodesAreLegalCheck(VerifiedClassImpl.Builder.MethodVerification verification) {
		verification.super();
