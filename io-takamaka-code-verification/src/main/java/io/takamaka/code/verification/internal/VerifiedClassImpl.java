...
import io.takamaka.code.verification.internal.checksOnMethods.PayableCodeIsEntryOfContractCheck;
...
import io.takamaka.code.verification.internal.checksOnMethods.RedPayableCodeIsEntryOfRedGreenContractCheck;
	...
	public class Builder {
		...
		public class MethodVerification {
			...
			private MethodVerification(MethodGen method) {
				...
				new PayableCodeIsEntryOfContractCheck(this);
				new RedPayableCodeIsEntryOfRedGreenContractCheck(this);
