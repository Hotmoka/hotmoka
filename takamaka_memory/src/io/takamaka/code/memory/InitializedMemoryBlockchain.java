...
import io.takamaka.code.memory.internal.InitializedMemoryBlockchainImpl;
 ...
 */
public interface InitializedMemoryBlockchain extends SequentialNode {
	 ...
	 */
	static InitializedMemoryBlockchain of(Path takamakaCodePath, BigInteger... funds) throws IOException, TransactionException, CodeExecutionException {
		return new InitializedMemoryBlockchainImpl(takamakaCodePath, funds);
	}
