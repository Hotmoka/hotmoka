...
public interface Node extends AutoCloseable {
	 ...
	 * 
	 * @param key the key of the events that will be forwarded to the handler; if this is {@code null},
	 ...
	 */
	Subscription subscribeToEvents(StorageReference key, BiConsumer<StorageReference, StorageReference> handler);
