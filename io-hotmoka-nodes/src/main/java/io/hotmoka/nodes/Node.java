...
public interface Node {
	...
	/**
	 * Yields the response that was generated by the jar store transaction with the given reference.
	 * 
	 * @param transactionReference the reference to the transaction
	 * @return the response
	 * @throws Exception if the response could not be found or is not for a jar store transaction
	 */
	TransactionResponseWithInstrumentedJar getJarStoreResponseAt(TransactionReference transactionReference) throws Exception;
