...
public interface Node extends AutoCloseable {
	 ...
	 */
	Stream<Update> getLastEagerUpdates(StorageReference storageReference) throws Exception;
	 ...
	 */
	UpdateOfField getLastLazyUpdateToNonFinalField(StorageReference storageReference, FieldSignature field) throws Exception;
	 ...
	 * @throws Exception if the update could not be found
	 */
	UpdateOfField getLastLazyUpdateToFinalField(StorageReference storageReference, FieldSignature field) throws Exception;
	 ...
	 */
	ClassTag getClassTag(StorageReference storageReference) throws Exception;
