...
public interface Node {
	 ...
	 * @throws Exception if the jar could not be found, for instance because the referenced transaction didn't install a jar in blockchain
	 */
	byte[] getInstrumentedJarAt(TransactionReference transactionReference) throws Exception;
