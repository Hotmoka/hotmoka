#!/bin/bash
pandoc Takamaka.md --filter pandoc-citeproc --bibliography=references.bib -o Takamaka.tex "-fmarkdown-implicit_figures -o" --from=markdown --include-in-header mystylefile.tex --toc --highlight-style=kate -V geometry:a4paper -V documentclass:book -V pagestyle:headings -V papersize:a4 -V colorlinks:true
