...
public class Mint extends AbstractCommand {
	...
	private class Run {
		...
		private void mint() throws Exception {
			...
			StorageReference account = MintBurnHelpers.of(node).mint(keys, SignatureAlgorithms.ed25519(SignedTransactionRequest::toByteArrayWithoutSignature), publicKeyOfAccountBase64Encoded, amount);
