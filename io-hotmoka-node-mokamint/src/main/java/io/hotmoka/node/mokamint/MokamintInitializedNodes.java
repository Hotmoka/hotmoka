...
import io.hotmoka.node.mokamint.internal.MokamintInitializedNodeImpl;

/**
 * Providers of Hotmoka nodes based on Mokamint, where the jar with the basic Takamaka classes have been installed,
 * along with a gamete and a manifest.
 */
public abstract class MokamintInitializedNodes {

	private MokamintInitializedNodes() {}
	 ...
	 */
	public static MokamintInitializedNode of(MokamintNode<?> parent, ConsensusConfig<?,?> consensus, Path takamakaCode)
		...
		return new MokamintInitializedNodeImpl(parent, consensus, null, takamakaCode);
	}
	 ...
	 * @throws ClosedNodeException if the node is already closed
	 */
	public static MokamintInitializedNode of(MokamintNode<?> parent, ConsensusConfig<?,?> consensus, ProducerOfStorageObject producerOfGasStation, Path takamakaCode)
			throws TransactionRejectedException, TransactionException, CodeExecutionException, IOException, TimeoutException, InterruptedException, ClosedNodeException, UnexpectedCodeException {

		return new MokamintInitializedNodeImpl(parent, consensus, producerOfGasStation, takamakaCode);
	}
}